#ifndef lint
static char     rcsid[]="$Id: command.c,v 3.4.1.1 91/06/25 21:07:09 katogi GM Locker: katogi $";
#endif
/*
*
...
{
    /*    messages    */
    static char    ubFind[]  = " î  ì ";
    static char    ubErace[] = "                    ";
    static char    *ubMes[]  = {
        "ü½  îìæÅôù    ",
        "ééééééé±. ëé",
        "âLü[éëééé¡éééó",
    };
...
{
    /*    messages    */
    static char     ubDel[]  = " ìø  Å£ ";
    static char     ubMes[]  = "ü½  ìøÅ£æÅ <Y / N>";
    static char     ubPrcs[] = "ìøÅ£Æåéé. éééé¡é¿æéé¡éééó.";
    static char     ubErr[]  = "ééêÅéìøÅ£éé½ééé±.";
           char     ubAnswer;
    ...
    do {
        ...
        CSRON();
        vfGetKey(&ubAnswer);
    } while (!(ubAnswer == 'y' || ubAnswer == 'Y' || ubAnswer == ''
             || ubAnswer == 'n' || ubAnswer == 'N' || ubAnswer == ''
             || ubAnswer == ESC));
    CSROFF();
    switch (ubAnswer){
        /*---------- do it! ----------*/
    ...
    sDATASET    *sDAT;     /* pointer to data buffer        */
{
    ...
    static char    ubInst[] = " æ}  ô ";
    static char    ubPrcs[] = "êô«Æåéé. éééé¡é¿æéé¡éééó.";
    static char    *ubMes[] = {
        "ô»éôééöêôéê", 
        "ô«ééæ}ôÉµéÄwÆé", 
        "éé¡éééó.",
	...
	CSRXY(3,18);
	printf("  æ}ôâfü[â^ %4d %-12s %-44s", iPoint1 + 1,yomibuf,kanjibuf);
	...
	CSRXY(3,18);
	printf("   æ}ôÉµ :  %4d %-12s %-44s", iPoint2 + 1,yomibuf,kanjibuf);
    ...
    sDATASET    *sDAT;        /* pointer to data buffer        */
{
    ...
    static char    ubPrcs[]   = "îèÆåéé. éééé¡é¿æéé¡éééó.";
    static char    *ubMes[]   = {
        "ô»éôééöêôéê",
        "ô«ééîèÉµéÄwÆé",
        "éé¡éééó.",
	...
	CSRXY(3,18);
	printf("îèîâfü[â^ %4d %-12s %-44s", wPoint1 + 1,yomibuf,kanjibuf);
	...
	CSRXY(3,18);
	printf("îèÉµâfü[â^ %4d %-12s %-44s", wPoint2 + 1,yomibuf,kanjibuf);
    ...
    sDATASET    *sDAT;        /* pointer to data buffer        */
{
    /*    messages    */
	static char    ubEmsg[] = "â}âXâNÆåéÄìsééééééé½ééé±. ";
    static char    ubPrint[]  = " ê  ì ";
    static char    ubStart[]  = "èJÄnêÆuÄwÆ";
    static char    ubEnd[]    = "ÅIùêÆuÄwÆ";
    static char    *ubRange[] = {
         "  Æå  Ä~  ", 
         " æS ÆP î ", 
         " öêÄwÆ ",
    ...
    static char    *ubOrder[] = {
        "êô«éé[RET]é","ëééé¡éééó",
    };
    static char    ubPrinting[] = 
        "êìÆåéé.éééé¡é¿æéé¡éééó.";
    REG      i;
    UBYTE    ubKey;           /* key code buffer                       */
...
{
    /*    messages    */
    static char    ubEdit[] = " òiÄîòÅW ";
    static char    *ubMes[] = {
        "òiÄîòÅWééé¡éééó",
        "[SPC] é BIT ON/OFF ",
    };
    UBYTE    ubKey;            /* key code                       */
