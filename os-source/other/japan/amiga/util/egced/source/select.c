#ifndef lint
static char     rcsid[]="$Id: select.c,v 3.4.1.1 91/06/25 21:07:28 katogi GM Locker: katogi $";
#endif
/*
*
...
#ifdef    UNIX
    static char    *ubMenu[] = {
        "\033[%d;38mF:îì", "\033[%d;38mM:ÅCÉ",
        "\033[%d;38mD:ìøÅ£", "\033[%d;38mE:ôoÿ^",
        "\033[%d;38mC:îè", "\033[%d;38mI:æ}ô",
        "\033[%d;38mW:òæ", "\033[%d;38mP:êì", 
        "\033[%d;38mQ:ÅIù"
    };
#else
    static char    *ubMenu[] = {
        "\033[%d;33mF\033[%d;38m:îì", "\033[%d;33mM\033[%d;38m:ÅCÉ",
        "\033[%d;33mD\033[%d;38m:ìøÅ£", "\033[%d;33mE\033[%d;38m:ôoÿ^",
        "\033[%d;33mC\033[%d;38m:îè", "\033[%d;33mI\033[%d;38m:æ}ô",
        "\033[%d;33mW\033[%d;38m:òæ", "\033[%d;33mP\033[%d;38m:êì", 
        "\033[%d;33mQ\033[%d;38m:ÅIù"
    };
#endif
