...
{
       REG        i, j;
static char    *cErr = "  âüâéâèé¬æ½éééé±.âüâéâèü[éèJòééé.";

    CSRXY(3, 6); printf("âüâéâèèmòÆå...");
...
VOID    vfSetMonitor()
{
    ...
    static char    *ubItem[] = {
        "ûÉlÆnûÉlîºÉöÉÉÅòÉöòÆPò¢ÉÿAî`î`ò¬âTâUêâJâKâTâ^âiâoâ}âëâÅ",
        "ÄîûûÄîûïµ  ô¬ö÷Éö    è  ææùeô«ùòòÆiìsìsìsìsìsìsìsìsìs",
        "éPÉÄîéQûûÄîÄîîÄîÄÜÉÄÜÄîÄîÄîÄîÄîòsô«ô«ô«éTéTéTéTéTéTéTéTéT",
    };
	...
	static	char	*ubBoxFlm[] = {
		"å«", "å", "å", "å", "åñ", "åó","å","å","å","å"
	};
	static char		cHorizLongFlm []= "åóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåóåó";
	static char		cHorizShortFlm []= "åóåóåóåóåóåóåóåóåóåóåóåóåóåó";
	static char		cVertFlm[] = "åñ";
