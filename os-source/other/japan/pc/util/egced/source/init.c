#ifndef lint
static char     rcsid[]="$Id: init.c,v 40.0 93/06/08 10:59:49 brummer Exp $";
#endif
/*
*
...
{
       REG        i, j;
static char    *cErr = "  ƒƒ‚ƒŠ‚ª‘«‚è‚Ü‚¹‚ñ.ƒƒ‚ƒŠ[‚ðŠJ•ú‚µ‚Ü‚·.";

    CSRXY(3, 6); printf("ƒƒ‚ƒŠŠm•Û’†...");
...
VOID    vfSetMonitor()
{
    ...
    static char    *ubItem[] = {
        "–¼l’n–¼lŒ§”ÚÚ•”•¶’P•›Ú˜AŒ`Œ`•ªƒTƒUˆêƒJƒKƒTƒ^ƒiƒoƒ}ƒ‰ƒ",
        "ŽŒ–¼–¼ŽŒ–¼‹æ  “ª”ö”    Š¿  ‘±‘Ì—e“®—Þ•Ï•Ï’isssssssss",
        "‚P©ŽŒ‚Q–¼–¼ŽŒŽŒŒêŽŒŽšßŽšŽŒŽŒŽŒŽŒŽŒ•s“®“®“®‚T‚T‚T‚T‚T‚T‚T‚T‚T",
    };
