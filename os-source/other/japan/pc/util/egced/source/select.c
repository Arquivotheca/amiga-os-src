...
#ifdef    UNIX
    static char    *ubMenu[] = {
        "\033[%d;38mF:ŒŸõ", "\033[%d;38mM:C³",
        "\033[%d;38mD:íœ", "\033[%d;38mE:“o˜^",
        "\033[%d;38mC:ŒðŠ·", "\033[%d;38mI:‘}“ü",
        "\033[%d;38mW:•Û‘¶", "\033[%d;38mP:ˆóü", 
        "\033[%d;38mQ:I—¹"
    };
#else
    static char    *ubMenu[] = {
        "\033[%d;33mF\033[%d;38m:ŒŸõ", "\033[%d;33mM\033[%d;38m:C³",
        "\033[%d;33mD\033[%d;38m:íœ", "\033[%d;33mE\033[%d;38m:“o˜^",
        "\033[%d;33mC\033[%d;38m:ŒðŠ·", "\033[%d;33mI\033[%d;38m:‘}“ü",
        "\033[%d;33mW\033[%d;38m:•Û‘¶", "\033[%d;33mP\033[%d;38m:ˆóü", 
        ...
        /*----- get command mode -----*/
            ...
            do {
                ...
                if (ubKey == LFT){
                    ...
                    /*---------        dilect command         --------*/
                    ubKey != 'f' && ubKey != 'F' && ubKey != 'Ê' &&
                    ubKey != 'd' && ubKey != 'D' && ubKey != '¼' &&
                    ubKey != 'e' && ubKey != 'E' && ubKey != '²' &&
                    ubKey != 'c' && ubKey != 'C' && ubKey != '¿' &&
                    ubKey != 'w' && ubKey != 'W' && ubKey != 'Ã' &&
                    ubKey != 'm' && ubKey != 'M' && ubKey != 'Ó' &&
                    ubKey != 'i' && ubKey != 'I' && ubKey != 'Æ' &&
                    ubKey != 'p' && ubKey != 'P' && ubKey != '¾' &&
                    ubKey != 'q' && ubKey != 'Q' && ubKey !='À' );
