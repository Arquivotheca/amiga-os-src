...
*	Source Control
*	--------------
*	$Header: internal.i,v 34.15 88/04/04 20:41:16 bart Exp $
*
*	$Locker:  $
*
*	$Log:	internal.i,v $
*   Revision 34.15  88/04/04  20:41:16  bart
*   MIN_TIMEOUT EQU $20 ; 250 milliseconds recommended
*   
*   Revision 34.14  88/04/02  14:25:55  bart
*   8 , 8 sector buffers
*   
*   Revision 34.13  88/04/02  13:48:52  bart
*   overscan support
*   
*   Revision 34.12  88/02/23  10:56:24  bart
*   back to 2 sec timeout for stupid seagate drive
*   
*   Revision 34.11  88/02/22  18:00:21  bart
*   SCSI_TIMEOUT    EQU $20 ; SCSI Timeout period -> 250 milliseconds recommended
*   
*   Revision 34.10  88/02/22  10:45:52  bart
*   HD_SCSI_ST_0 .. 9
*   
*   Revision 34.9  87/12/04  19:14:27  bart
*   checkpoint
*   
*   Revision 34.8  87/12/04  12:09:11  bart
*   checkpoint before adding check for existing dosname on eb_mountlist
*   
*   Revision 34.7  87/10/14  15:43:34  bart
*   10-13 rev 1
*   
*   Revision 34.6  87/10/14  14:16:27  bart
*   beginning update to cbm-source.10.13.87
*   
*   Revision 34.5  87/07/08  14:01:23  bart
*   y
*   
*   Revision 34.4  87/06/11  15:48:33  bart
*   working autoboot 06.11.87 bart
*   
*   Revision 34.3  87/06/03  10:59:36  bart
*   checkpoint
*   
*   Revision 34.2  87/05/31  16:36:13  bart
*   chickpoint
*   
*   Revision 34.1  87/05/29  19:39:49  bart
*   checkpoint
*   
*   Revision 34.0  87/05/29  17:40:13  bart
...
NUM_BUFS	EQU	8	; Number of buffers in the system (was 6)
BUF_SECTS	EQU	8	; Number of sectors per buffer
...
MIN_TIMEOUT	EQU	$20	; SCSI Timeout period -> 250 milliseconds recommended
...
*-- Pseudo-device Structure : one per controller board
 STRUCTURE HD,0
	...
	UBYTE   HD_SCSI_ST_0		; Save SCSI phase
	UBYTE   HD_SCSI_ST_1        ; Save SCSI status
	UBYTE   HD_SCSI_ST_2        ; Save SCSI sense 
	UBYTE   HD_SCSI_ST_3        ; Save SCSI sense
	UBYTE   HD_SCSI_ST_4        ; Save SCSI sense
	UBYTE   HD_SCSI_ST_5        ; Save SCSI sense
	UBYTE   HD_SCSI_ST_6        ; Save SCSI sense
	UBYTE   HD_SCSI_ST_7        ; Save SCSI sense
	UBYTE   HD_SCSI_ST_8        ; Save SCSI sense
	UBYTE   HD_SCSI_ST_9        ; Save SCSI sense
