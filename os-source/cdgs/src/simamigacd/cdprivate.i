...
************************************************************************
 ...
 STRUCTURE CDDB,LIB_SIZE
        ...
        ULONG       db_DriveTask
        ULONG       db_TaskMsgPort

        ULONG       db_DriveTimerReq
...
TASK_SIGS equ (SIGF_CMDPORT|SIGF_DISKCMDPORT|SIGF_CMDDONE|SIGF_PLAYDONE|SIGF_DISKCHANGE|SIGF_ABORTDRIVE)
...
CLASSD_SIGS     equ     (SIGF_CMDDONE|SIGF_TOCDONE|SIGF_PBX|SIGF_ABORTDRIVE)
