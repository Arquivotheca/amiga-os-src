...
CmdQCode:
                ...
                move.b  #ADR_POSITION,(a1)+                                     ; CTLADR field

                move.l  #TOCEntry_SIZE,d1                                       ; Calculate track
                lea     db_TOC(db),a0
1$              add.l   #TOCEntry_SIZE,d1
                move.l  TOCE_Position(a0,d1),d0
                jsr     MSFtoLSN
                cmp.l   db_PlayPosition(db),d0
                bls     1$
                divu.l  #TOCEntry_SIZE,d1
                sub.l   #1,d1
                move.b  d1,(a1)+

                clr.w   (a1)+                                                   ; Disk and Track times
                move.l  db_PlayPosition(db),d0
                move.l  d0,4(a1)
                mulu.l  #TOCEntry_SIZE,d1
                move.l  TOCE_Position(a0,d1),d0
                jsr     MSFtoLSN
                move.l  db_PlayPosition(db),d1
                sub.l   d0,d1
                move.l  d1,(a1)

                tst.b   d2                                                      ; Convert to MSF format if requested
                bne     2$
...
2$
                ...
                rts
99$
                move.b  #CDERR_InvalidState,IO_ERROR(ior)
                restore d2
                rts
