...
DevFuncs                
                ...
                dc.l    CmdSampleTrack  ; 47
                dc.l    CmdSampleMSF    ; 48
                dc.l    CmdSampleLSN    ; 49
                dc.l    CmdSampleXLMSF  ; 50
                dc.l    CmdSampleXLLSN  ; 51
...
CmdOpts:
        ...
        dc.w  OF_QUEUE|OF_DISK|OF_DISKACCESS|OF_MULTITASK|OF_ABTD   ; CmdSampleTrack
        dc.w  OF_QUEUE|OF_DISK|OF_DISKACCESS|OF_MULTITASK|OF_ABTD   ; CmdSampleMSF
        dc.w  OF_QUEUE|OF_DISK|OF_DISKACCESS|OF_MULTITASK|OF_ABTD   ; CmdSampleLSN
        dc.w  OF_QUEUE|OF_DISK|OF_DISKACCESS|OF_MULTITASK|OF_ABTD   ; CmdSampleXLMSF
        dc.w  OF_QUEUE|OF_DISK|OF_DISKACCESS|OF_MULTITASK|OF_ABTD   ; CmdSampleXLLSN
        dc.w  0
