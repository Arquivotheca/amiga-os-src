...
CDROMPAGESIZE   equ     16*4096         ; 64k for 16 buffers
...
************************************************************************
 ...
 STRUCTURE CDDB,LIB_SIZE
        ...
        ULONG       db_Remap                        ; Should sectors be remapped?
        UBYTE       db_CDICount
        ALIGNLONG
        ...
        UBYTE       db_Sampling                     ; Sampling or playing?
        ALIGNLONG

        ULONG       db_SARG1                        ; Sample audio parameter copy
        ULONG       db_SARG2
        ULONG       db_SARG3
        ULONG       db_SARG4

        ULONG       db_AudioTarget                  ; Address where audio data is to be DMAed
        ULONG       db_SampleDump
        ...
        UBYTE       db_QAvail                       ; First Q-Code packet available?
        ...
        STRUCT      db_QCodeI,16                    ; Q-Code packet (interrupt)
...
TASK_SIGS       equ     (SIGF_CMDPORT|SIGF_DISKCMDPORT|SIGF_CMDDONE|SIGF_PLAYDONE|SIGF_DISKCHANGE|SIGF_ABORTDRIVE|SIGF_AUDPBX)

*** Class A and D Signals

 BITDEF SIG,CMDDONE,20

*** Class A Signals

 BITDEF SIG,QCODE,21
 BITDEF SIG,ABORTQCODE,22

CLASSA_SIGS     equ     (SIGF_CMDDONE|SIGF_QCODE|SIGF_ABORTQCODE)

*** Class D Signals

 BITDEF SIG,TOCDONE,23
 BITDEF SIG,PBX,24
 BITDEF SIG,ABORTDRIVE,25
 BITDEF SIG,AUDPBX,26

CLASSD_SIGS     equ     (SIGF_CMDDONE|SIGF_TOCDONE|SIGF_PBX|SIGF_ABORTDRIVE|SIGF_AUDPBX)
...
CDCMD_SAMPLE            equ $B          ; (M) Play from start, stop before end
                                        ;     <SMIN><SSEC><SFRM> <EMIN><ESEC><EFRM> <MODE> <DATA>
