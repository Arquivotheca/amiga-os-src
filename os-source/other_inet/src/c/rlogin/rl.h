...
#define MAX_CONFIGFILE_LEN     256L
#define MAX_FKEYLEN            128L
...
struct glob {
	...
	UBYTE  g_user_configfile[MAX_CONFIGFILE_LEN] ; /* the user's config file (-f) */
	...
	BOOL   g_localfkeys ;                    /* default = 0 = termcap defs  */
	BYTE   g_fkeys[10][MAX_FKEYLEN] ;
	BYTE   g_sfkeys[10][MAX_FKEYLEN] ;
	int    g_fklf[10] ;
	int    g_sfkeylf[10] ;
	} ;
...
BOOL   RAParse( LONG *opts, struct glob *g, BOOL is_configfile );
...
#define TEMPLATE "HOST/A,-L=USER/K,-F=FILE/K,-X=LEFT/K/N,-Y=TOP/K/N,\
-W=WIDTH/K/N,-H=HEIGHT/K/N,-S=SCREEN/S,-T=TERMTYPE/K,-M=MODE/K,-D=DEPTH/K/N,\
-U=CONUNIT/K/N,-NR=NORESIZE/S,-NJ=NOJUMP/S,-NW=NOWRAP/S,-P=PASTEDELAY/K/N,\
-MS=MINSIZE/S,-P0=PEN0/K,-P1=PEN1/K,-P2=PEN2/K,-P3=PEN3/K,-P4=PEN4/K,\
-P5=PEN5/K,-P6=PEN6/K,-P7=PEN7/K,-K1=FKEY1/K,-K2=FKEY2/K,-K3=FKEY3/K,\
-K4=FKEY4/K,-K5=FKEY5/K,-K6=FKEY6/K,-K7=FKEY7/K,-K8=FKEY8/K,-K9=FKEY9/K,\
-K10=FKEY10/K,-LFK=LOCALFKEYS/S"
...
#define OPT_FKEY8       32
#define OPT_FKEY9       33
#define OPT_FKEY10      34
	#define OPT_FKEYMAX OPT_FKEY10 + 1
#define OPT_LOCALFKEY   35
#define OPT_COUNT       36
