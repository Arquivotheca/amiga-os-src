 ...
 * $Locker:  $
 *
 * $Id: console.c,v 37.26 93/02/11 17:46:54 bj Exp $
 *
 * $Revision: 37.26 $
 *                                                              
 * $Log:	console.c,v $
 * Revision 37.26  93/02/11  17:46:54  bj
 ...
 * 
 *
 *  $Header: AS225:src/c/rlogin/RCS/console.c,v 37.26 93/02/11 17:46:54 bj Exp $
 *
 * ==========================================================================
 */
...
//		printf("rlogin: screen height = %ld\n", (long)myscreen->Height ) ;
//		printf("rlogin: window height = %ld\n", (long)win->Height) ;
