...
struct RexxTask {
   ...
   APTR     rt_ClientID;               /* the client's task ID       ERH*/
   APTR     rt_MsgPkt;                 /* the packet being processed ERH*/
   APTR     rt_TaskID;                 /* our task ID                ERH*/
   APTR     rt_RexxPort;               /* the REXX public port       ERH*/

   APTR     rt_ErrTrap;                /* Error trap address         ERH*/
   APTR     rt_StackPtr;               /* stack pointer for traps    ERH*/
