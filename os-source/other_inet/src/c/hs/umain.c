/* -----------------------------------------------------------------------
 * umain.c		handshake_src
 *
 * $Locker:  $
 *
 * $Id: umain.c,v 1.1 91/05/09 16:20:01 bj Exp $
 *
 * $Revision: 1.1 $
 *
 * $Header: HOG:Other/inet/src/c/hs/RCS/umain.c,v 1.1 91/05/09 16:20:01 bj Exp $
 *
 * $Log:	umain.c,v $
 * Revision 1.1  91/05/09  16:20:01  bj
 * Initial revision
 * 
 *
 *------------------------------------------------------------------------
