/* -----------------------------------------------------------------------
 * tinymain.c		handshake_src
 *
 * $Locker:  $
 *
 * $Id: tinymain.c,v 1.1 91/05/09 15:39:10 bj Exp $
 *
 * $Revision: 1.1 $
 *
 * $Header: HOG:Other/inet/src/c/hs/RCS/tinymain.c,v 1.1 91/05/09 15:39:10 bj Exp $
 *
 * $Log:	tinymain.c,v $
 * Revision 1.1  91/05/09  15:39:10  bj
 * Initial revision
 * 
 *
 *------------------------------------------------------------------------
