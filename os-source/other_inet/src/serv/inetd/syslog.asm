* -----------------------------------------------------------------------
# syslog.asm   (as225 inetd.  adds varargs to socket.library syslog()
#
# $Locker:  $
#
# $Id: syslog.asm,v 1.1 92/07/17 15:34:25 bj Exp $
#
# $Revision: 1.1 $
#
# $Log:	syslog.asm,v $
* Revision 1.1  92/07/17  15:34:25  bj
* Initial revision
* 
#
# $Header: AS225:src/serv/inetd/RCS/syslog.asm,v 1.1 92/07/17 15:34:25 bj Exp $
#
#------------------------------------------------------------------------
#
; syslog.asm
