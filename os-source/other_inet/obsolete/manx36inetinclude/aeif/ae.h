...
struct ae_iadr {
	...
	u_char	ladr[8];
#ifdef LATTICE
	u_int	rdra:16, rdra_hi:8, rdra_res:5, rlen:3;
	u_int	tdra:16, tdra_hi:8, tdra_res:5, tlen:3;
#else
	u_short	rdra;
...
struct ae_tdra {
#ifdef LATTICE
	u_int	tbadr:16, ha:8, flags:8;
	int	bcnt:16, tdr:10, rtry:1, lcar:1, lcol:1, res:1, uflo:1, buff:1;
#else
	u_short	tbadr;
	u_short ha:8, flags:8;
	short	bcnt;
