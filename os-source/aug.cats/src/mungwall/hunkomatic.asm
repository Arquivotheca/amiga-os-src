;$Id: hunkomatic.asm,v 37.70 1993/10/01 21:30:58 Vic rel $
;$Log: hunkomatic.asm,v $
;; Revision 37.70  1993/10/01  21:30:58  Vic
;; Changed - one branch to a short since the assembler tells us it can be;
;;           we might as well save the 2 bytes.
