;$Id: munge.asm,v 37.12 1993/10/01 22:07:49 Vic rel $

;$Log: munge.asm,v $
;; Revision 37.12  1993/10/01  22:07:49  Vic
;; Deleted - some unneccessary entry points for munglist
;; Added   - RCS Id and Log information
;; Changed - forced the version up to track current version of munglist
;;
