;/* mungwalltest.c - Execute me to compile me with SAS C 6.3
SC DATA=FAR NMINC STRMERGE STREQ NOSTKCHK SAVEDS IGNORE=73 mungwalltest.c
slink FROM LIB:c.o,mungwalltest.o TO mungwalltest LIBRARY LIB:SC.lib,LIB:Amiga.lib
quit

    $Id: mungwalltest.c,v 37.7 1993/10/01 18:30:20 Vic rel $
    
    $Log: mungwalltest.c,v $
 * Revision 37.7  1993/10/01  18:30:20  Vic
 * Changed - script commands at the beginning of the file to SAS C 6.x
 *         - version (natch)
 * Added   - RCS ID and Log for future changes
 *
...
char *vers = "\0$VER: mungwalltest 37.7";
char *Copyright =
