;
; unvscomp.asm - ANIM decompression code for op 5
; Based on Jim Kent's code.
; Jim's original readme attached.
;
;---------------------------------------------------------------------------- 
; *** README file ***
;
...
; should certainly be noted that the external pointer variable ytableptr
...
dcvsame					; here we decode a "vertical same run"
	...
	add.w	d1,d1
	neg.w	d1
	jmp	32+same_tower(pc,d1.w)	; size of tower
