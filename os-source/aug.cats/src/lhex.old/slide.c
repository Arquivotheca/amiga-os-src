...
STATIC /* inline */ node child(node q, unsigned char c) /* q's child for character c (NIL if not found) */
{
    node r;
...
STATIC /* inline */ void makechild(node q, unsigned char c, node r)	/* Let r be q's child for character c. */
{
    node h, t;
