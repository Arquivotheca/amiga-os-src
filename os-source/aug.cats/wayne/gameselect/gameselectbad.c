...
DoDisplay( UBYTE * ilbmname )
{
    ...
    kprintf("DoDisplay ENTERED with ilbmname= '%ls'\n",
	ilbmname ? ilbmname : "");
	...
	kprintf("DoDisplay() DoQuery returned FALSE\n");
	return( OpenPanel() );
    }
    ...
    kprintf("DoDisplay() END calling OpenPanel\n");
...
main( LONG argc,char * argv[] )
{
    ...
    kprintf("main() ILBMname from CommandLine= '%ls'\n",
	ILBMname ? ILBMname : "");
