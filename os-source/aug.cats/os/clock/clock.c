...
UBYTE defaultFmt;
    ...
    if (LocaleBase)
    {
        ...
        while (i < maxFmt)
        {
            if (strcmp(timeFormats[i],li.li_Locale->loc_ShortTimeFormat) == 0)
                found = TRUE;
        ...
        {
            defaultFmt = maxFmt;
            timeFormats[maxFmt]   = li.li_Locale->loc_ShortTimeFormat;
            timeSamples[maxFmt++] = sample1;
            GetTime(seconds,li.li_Locale->loc_ShortTimeFormat,sample1);
        }
        ...
        while (i < maxFmt)
        {
            if (strcmp(timeFormats[i],li.li_Locale->loc_TimeFormat) == 0)
                found = TRUE;
        ...
        {
            defaultFmt = maxFmt;
            timeFormats[maxFmt]   = li.li_Locale->loc_TimeFormat;
            timeSamples[maxFmt++] = sample2;
            GetTime(seconds,li.li_Locale->loc_TimeFormat,sample2);
        }
        ...
        dateFormat = li.li_Locale->loc_ShortDateFormat;
