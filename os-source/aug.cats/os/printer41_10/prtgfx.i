...
**
**	$Id: prtgfx.i,v 1.12 90/07/26 16:50:28 valentin Exp $
**
...
PCMWHITE	EQU	PCMBLACK	; byte index for white
	...
	STRUCTURE	PrtInfo,0
		...
		* V41+ below here
		APTR	pi_ColorTmp	; PRIVATE - DO NOT USE!
		APTR 	pi_dmatrix8	; pointer to 8x8 dither matrix for drivers
		APTR	pi_dmatrix16	; pointer to 16x16 dither matrix for drivers
		APTR	pi_colorfunc    ; pointer to SPECIAL_COLORFUNC function
