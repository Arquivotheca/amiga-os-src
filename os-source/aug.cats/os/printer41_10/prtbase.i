...
**
**	$Id: prtbase.i,v 1.9 90/07/26 16:57:27 valentin Exp $
**
...
* New for V41 - flag bit for pd_Flags1
PDB_24BIT	EQU	0	* 24-bit color printer device
PDF_24BIT	EQU	$01	* 24-bit color (and/or flag)
...
PCC_24BIT	EQU	$20	;driver wants 24-bit color info (V42+)

 STRUCTURE  PrinterExtendedData,0
    APTR    ped_PrinterName   ; printer name, null terminated
    APTR    ped_Init          ; called after LoadSeg (0=OK, -1=FAIL)
