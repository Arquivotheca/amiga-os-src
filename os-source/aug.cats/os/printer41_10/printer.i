...
**
**	$Id: printer.i,v 1.7 90/07/26 17:01:35 valentin Exp $
**
...
;
;	For SPECIAL_COLORFUNC, instead of io_ColorMap, pass a pointer to
;	your register-based function which provides the following register
;	interface (see also prtgfx.i):
;
;	  void colorfunc(ULONG x, ULONG y, ULONG width, union colorEntry *);
;			       d0        d1       d2              a0
;
;	Your function will be called whenever the printer.device needs
;	color information for your RastPort's pixels.  Your function may
;	not call any dos functions, and must preserve registers other than
;	d0, d1, a0, a1.  In addition, your function is responsible for
;	providing its own A4 if your code is base-relative.
;	The RastPort you pass, and its BitMap, will still be accessed
;	by the printer for other information it needs. 
;
SPECIAL_COLORFUNC	EQU	$4000  /* see above */
...
PDERR_OLDDEVICE		EQU	9	; Driver needs newer printer.device
