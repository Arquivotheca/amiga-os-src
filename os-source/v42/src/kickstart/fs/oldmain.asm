...
;		move.l	d1,0			kluge for 2091 loc 0 bug
...
; printf <'pkt=RENAME_OBJECT %lx,%b,%lx,%b\n'>,dp_Arg1(a0),dp_Arg2(a0),dp_Arg3(a0),dp_Arg4(a0)
 printf <'pkt=RENAME_OBJECT %lx,%lx,%lx,%lx\n'>,dp_Arg1(a0),dp_Arg2(a0),dp_Arg3(a0),dp_Arg4(a0)
		XREF	Rename
...
; printf <'pkt=LOCATE_OBJECT %lx,%b,%ld\n'>,dp_Arg1(a0),dp_Arg2(a0),dp_Arg3(a0)
 printf <'pkt=LOCATE_OBJECT %lx,%lx,%ld\n'>,dp_Arg1(a0),dp_Arg2(a0),dp_Arg3(a0)
		XREF	UserLocate
		movea.l	a0,a1			stash packet for startco
...
rtn_CURRENT_VOLUME:
	printf <'pkt=CURRENT_VOLUME\n'>
		tst.l	dp_Arg1(a0)
		bne	CallAccess		call access for the volume ^^
...
5$		move.l	DiskType(a5),d0
		...
		bne.s	1$
		clr.b	d0			knock off the number for DOS\1
