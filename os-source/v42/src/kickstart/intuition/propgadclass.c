 ...
 *
 *  $Id: propgadclass.c,v 40.0 94/02/15 17:30:43 davidj Exp $
 *
...
{
    return (UWORD) imax (ss->ss_Total - ss->ss_Visible, 0);
}
...
static UWORD propTop (struct PGIData *pgi)
{
    ...
    return (UWORD)(((ULONG) hidden * pot + MAXPOT / 2) / MAXPOT);
}
...
static void updatePropInfo (struct PGIData *pgi)
{
...
static ULONG getPropGadgetAttrs (Class *cl, Object *o, struct opGet *msg)
{
    struct PGIData *pgi;
...
static LONG setPropGadgetAttrs (Class *cl, Object *o, struct opSet *msg)
{
...
static ULONG propgadgetDispatch (Class *cl, Object *o, Msg msg)
{
	...
	case OM_NEW:
		...
		/* defaults */
				 GA_IMAGE, GetUserTagData (GA_IMAGE, (ULONG)&pgi->pgi_AutoKnob,
...
#if 1
		setPropGadgetAttrs (cl, newobj, (struct opSet *) msg);
#else
	...
	case OM_UPDATE:
		...
		refresh += setPropGadgetAttrs (cl, o, (struct opSet *) msg);
	...
	case OM_GET:
	    return (getPropGadgetAttrs (cl, o, (struct opGet *) msg));
...
/* should be replaced by magic somewhere, but this is a ROM class, so I don't
...
Class *initPropGadgetClass (void)
{
    ...
    return (makePublicClass (PropGClassName, GadgetClassName, sizeof (struct PGIData), propgadgetDispatch));
}
