 ...
 *
 *  $Id: ih.c,v 40.0 94/02/15 17:40:18 davidj Exp $
 *
...
static void runIntuition (struct InputEvent *ie)
{
...
void windowEvent (struct Window *sendwindow, ULONG ieclass, ULONG iecode)
{
    ...
    DIE (
	    ...
	    printf ("wE: a 'fake' input event with this token\n"));
