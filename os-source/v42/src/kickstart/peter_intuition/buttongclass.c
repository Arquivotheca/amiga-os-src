...
static ULONG dispatchButtonG(Class * cl,
                             Object * o,
                             Msg msg);

static int renderButtonG(struct RastPort * rp,
                         struct GadgetInfo * gi,
                         Object * o,
                         int redraw_mode);

static int setButtonAttrs(Class * cl,
                          Object * o,
                          struct opSet * msg);
