 ...
 *
 *  $Id: frameiclass.c,v 38.5 92/11/25 15:39:37 peter Exp $
 *
...
#include "frameiclass_protos.h"

/*---------------------------------------------------------------------------*/

static ULONG dispatchFrameI(Class * cl,
                            Object * o,
                            Msg msg);

static int frameBox(Class * cl,
                    Object * o,
                    struct impFrameBox * msg);

static int drawFrameI(Class * cl,
                      Object * o,
                      struct impDraw * msg);
