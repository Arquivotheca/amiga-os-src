 ...
 *
 *  $Id: prefs.c,v 38.11 93/01/12 16:20:10 peter Exp $
 *
...
static int copyprefs(struct Preferences * from,
                     int size,
                     struct Preferences * to);

static int setIBasePrefs(void);

static int setWBColorsGruntGrunt(struct Screen * screen,
                                 int firstcolor,
                                 int numcolors,
                                 int ibcolor);
