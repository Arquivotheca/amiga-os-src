...
#include "screens_protos.h"

/*---------------------------------------------------------------------------*/

static struct Screen * realOpenScreenTagList(struct NewScreen * ns,
                                             struct IScreenModePrefs * sm,
                                             struct TagItem * tags);

static int closeScreenCommon(struct Screen * sc);

static int detachScreen(int sc);
