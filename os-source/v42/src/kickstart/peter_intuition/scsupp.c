 ...
 *
 *  $Id: scsupp.c,v 38.32 93/03/12 13:53:35 peter Exp $
 *
...
#endif
#include "scsupp_protos.h"

/*---------------------------------------------------------------------------*/

static int doMoveScreen(struct Screen * screen,
                        WORD x,
                        WORD y);

static LONG parentOriginX(struct Screen * child,
...
int flags;
{
	...
	{
	    struct Screen *tailsc = (struct Screen *)lastThing( scptr );
