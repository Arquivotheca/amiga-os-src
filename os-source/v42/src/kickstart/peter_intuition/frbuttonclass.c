...
#include "frbuttonclass_protos.h"

/*---------------------------------------------------------------------------*/

static ULONG dispatchFramedB(Class * cl,
                             Object * o,
                             Msg msg);

static int renderFramedB(struct RastPort * rp,
                         struct GadgetInfo * gi,
                         Object * o,
                         struct localObjData * lod,
                         int redraw_mode);

static int setFramedBAttrs(Class * cl,
                           Object * o,
                           struct opSet * msg);

static int getContentsExtent(Object * o,
                             struct DrawInfo * drinfo,
                             struct IBox * contents);

static int displayContents(struct RastPort * rp,
                           Object * o,
                           struct DrawInfo * drinfo,
                           WORD offsetx,
                           WORD offsety,
