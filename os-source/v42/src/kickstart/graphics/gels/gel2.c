...
*	Source Control
*	--------------
*	$Id: gel2.c,v 42.1 93/07/20 13:39:16 chrisg Exp $
*
*	$Locker:  $
*
*	$Log:	gel2.c,v $
 * Revision 42.1  93/07/20  13:39:16  chrisg
 * umuls gone.
 * 
 * Revision 42.0  93/06/16  11:18:58  chrisg
 * initial
 * 
 * Revision 42.0  1993/06/01  07:20:37  chrisg
 * *** empty log message ***
 *
