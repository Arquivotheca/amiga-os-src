...
/*
**	$Id: graphics_protos.h,v 36.3 90/05/21 12:18:35 bart Exp $
**
...
BOOL GetGBuffers( struct AnimObj *anOb, struct RastPort *rp, long flag );
void InitGMasks( struct AnimObj *anOb );
