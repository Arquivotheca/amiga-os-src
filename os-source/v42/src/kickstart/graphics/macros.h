...
*	Source Control
*	--------------
*	$Id: macros.h,v 42.0 93/06/16 11:11:47 chrisg Exp $
*
*	$Locker:  $
*
*	$Log:	macros.h,v $
 * Revision 42.0  93/06/16  11:11:47  chrisg
 * initial
 * 
 * Revision 42.0  1993/05/31  15:36:46  chrisg
 * *** empty log message ***
 *
*   Revision 39.9  93/05/19  13:48:09  chrisg
*   changed PASSRECT macro to make sas 6 happy.
*   
