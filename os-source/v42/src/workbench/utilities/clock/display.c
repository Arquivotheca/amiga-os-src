...
static VOID DrawHands(BOOL plotSeconds)
{
WORD  i;
...
static VOID DrawClock(BOOL plotSeconds)
{
WORD i, rx, ry;
 ...
 */
static VOID CalcBetas(ULONG seconds)
{
ULONG secs;
ULONG mins;
ULONG hrs;
...
static VOID ShowDate(ULONG seconds)   /* seconds since 01-Jan-78 */
{
