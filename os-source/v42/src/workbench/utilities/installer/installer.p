 ...
 *		installer.p
 *
 *	All of the Installer prototypes, I think!
 *
 *
 *	Revision History:
 *
 ...
 *	lwilton 07/26/93:
 *		Foramtted to make the file readable.
 */
...
int verify_string_arg		(struct Value *v, char *func, char *arg);
...
ULONG final_checkboxes		(struct Gadget *gad, short total);
