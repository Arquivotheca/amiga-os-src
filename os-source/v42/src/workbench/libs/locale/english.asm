...
;---------------------------------------------------------------------------
	...
	INCLUDE "languagedrivers.i"

	LIST

;---------------------------------------------------------------------------

	XDEF _EnglishConvToLower
	XDEF _EnglishConvToUpper
	XDEF _EnglishGetCodeSet
	XDEF _EnglishGetDriverInfo
	XDEF _EnglishGetLocaleStr
	XDEF _EnglishIsAlNum
	XDEF _EnglishIsAlpha
	XDEF _EnglishIsCntrl
	XDEF _EnglishIsDigit
	XDEF _EnglishIsGraph
	XDEF _EnglishIsLower
	XDEF _EnglishIsPrint
	XDEF _EnglishIsPunct
	XDEF _EnglishIsSpace
	XDEF _EnglishIsUpper
	XDEF _EnglishIsXDigit
	XDEF _EnglishStrConvert
	XDEF _EnglishStrnCmp
