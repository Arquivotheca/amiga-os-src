...
APTR SMRequest(struct ASLLib *AslBase, struct ExtSMReq *requester, struct TagItem *tagList);
VOID FreeSMRequest(struct ASLLib *AslBase, struct ExtSMReq *requester);
