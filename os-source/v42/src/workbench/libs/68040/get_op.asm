*
* $Id: get_op.asm,v 0.5 91/07/11 09:50:59 mks Exp $
*
* $Log:	get_op.asm,v $
* Revision 0.5  91/07/11  09:50:59  mks
...
* 
* Revision 0.4  91/07/08  15:49:14  mks
...
*
* Revision 0.3  91/07/03  10:26:05  mks
* First pass at doing branch optimizations
*
* Revision 0.2  91/07/02  14:40:50  mks
* Added conditional kludges for FMOVEM bug fix
*
* Revision 0.1  91/06/26  09:01:27  mks
* Initial check in...
*
*
...
*
	bne.s	not_fmovecr	;handle fmovecr as an unimplemented inst
	rts
