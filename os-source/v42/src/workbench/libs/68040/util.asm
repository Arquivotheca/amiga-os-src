*
* $Id: util.asm,v 0.4 91/07/03 10:28:41 mks Exp $
*
* $Log:	util.asm,v $
* Revision 0.4  91/07/03  10:28:41  mks
* First pass at doing branch optimizations
* 
* Revision 0.3  91/07/02  15:52:38  mks
* Did optimizations for unified memory since the Amiga system
* runs as unified address space.
*
* Revision 0.2  91/06/26  13:28:16  mks
* Removed the "check_force" routine as per MOTO FAX of 6/14/91
*
* Revision 0.1  91/06/26  08:59:07  mks
* Initial check in...
*
*
...
ovf_e3_exc:
	...
	cmpi.l	#$00000040,d0
	beq.s	ovf_force_sgl		;force precision is single
	cmpi.l	#$00000060,d0
	beq.s	ovf_force_dbl		;force precision is double
	...
	cmpi.l	#$30,d0
	beq.s	ovf_fsgl
	bra.s	ovf_fpcr		;instruction is none of the above
*					;use FPCR
ovf_e1_exc:
	move.w	CMDREG1B(a6),d0		;get command word
	andi.l	#$00000044,d0		;clear all bits except 6 and 2
	cmpi.l	#$00000040,d0
	beq.s	ovf_force_sgl		;the instruction is force single
	cmpi.l	#$00000044,d0
	beq.s	ovf_force_dbl		;the instruction is force double
...
d_rm_neg:
	lea.l	EXT_PINF,a1	;answer is negative infinity
	or.l	#neginf_mask,USER_FPSR(a6)
	bra.s	end_ovfr	;inf is same for all precisions (ext,dbl,sgl)
d_rm_pos:
...
unf_e3_exc:
	...
	cmpi.l	#$2,d0
	beq.s	unf_force_sgl	;force precision is single
...
*				;are the command word
	...
	cmpi.l	#$00400000,d0
	beq.s	unf_force_sgl	;force single
