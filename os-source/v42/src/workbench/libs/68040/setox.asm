*
* $Id: setox.asm,v 0.4 91/07/11 09:49:20 mks Exp $
*
* $Log:	setox.asm,v $
* Revision 0.4  91/07/11  09:49:20  mks
...
*
* Revision 0.3  91/07/08  15:47:52  mks
...
*
* Revision 0.2  91/07/02  14:39:28  mks
* Added conditional kludges for FMOVEM bug fix
*
* Revision 0.1  91/06/26  09:00:27  mks
* Initial check in...
*
*
