...
**
ENVOYERR_NOAUTHSERV      SET     541   ** SelectServer() not called
ENVOYERR_NOAUTHORITY     SET     542   ** Authority is not sufficient for
**                                        requested action
ENVOYERR_NOOBJECT        SET     543   ** Object not found in authentication
**                                        database
ENVOYERR_OBJEXISTS       SET     544   ** Attempt to add object with same name as
**                                        an existing object
ENVOYERR_IOERR           SET     545   ** Server can't read/write disk
ENVOYERR_ZEROLENGTHNAME  SET     546   ** Can't have zero length names.
ENVOYERR_ID1UNDELETABLE  SET     547   ** Can't delete U/GID 1
