...
*
*   SYNOPSIS
*	error = StartService(username, password, entityname)
*	d0                   A0        A1        A2
*
*	ULONG StartService(STRPTR, STRPTR, STRPTR);
*
*   FUNCTION
...
*
*   INPUTS
*	username - Pointer to the name of the user requesting the service.
*	password - Pointer to the user's password as sent by the client.
*	entityname - Pointer to a buffer to fill in with your Entity name.
*
*   RESULT
