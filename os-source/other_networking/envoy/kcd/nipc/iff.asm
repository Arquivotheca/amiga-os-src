...
; Put up our error requester
	movea.l	nb_SysBase(a4),a6
	lea.l	IntuitionName(pc),a1
	jsrlib	OpenLibrary
	move.l	d0,a6
	suba.l	a0,a0
	lea.l	IFFEasyStruct(pc),a1
	movea.l	a0,a2
	movea.l	a0,a3
...
NoConfigName	dc.b	'NIPC',0
NoConfigMsg	dc.b	'Could not open nipc',10,'configuration file.',0
NoConfigGads	dc.b	'Retry|Cancel',0

	CNOP	0,4

IFFEasyStruct	dc.l	EasyStruct_SIZEOF
		dc.l	0
		dc.l	NoConfigName
		dc.l	NoConfigMsg
		dc.l	NoConfigGads