/*
**	$Id: exec_pragmas.h,v 39.15 93/10/01 09:19:58 darren Exp $
**
...
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase ExitIntr 24 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase Schedule 2a 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase Reschedule 30 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase Switch 36 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase Dispatch 3c 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase Exception 42 00
#endif
/*------ module creation ----------------------------------------------*/
...
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase RawIOInit 1f8 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase RawMayGetChar 1fe 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase RawPutChar 204 00
#endif
/*------ misc ---------------------------------------------------------*/
...
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase ExecReserved04 318 001
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase ExecReserved05 31e 001
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase ExecReserved06 324 001
#endif
...
/* More reserved LVOs */
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase ReadGayle 330 00
#endif
#ifdef EXEC_PRIVATE_PRAGMAS
#pragma libcall SysBase ExecReserved08 336 001
#endif
