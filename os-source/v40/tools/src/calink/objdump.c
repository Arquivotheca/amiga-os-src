...
#define pubmem 0
#define chipmem 0x40000000L
#define fastmem 0x80000000L
#define memmask 0xC0000000L
#define typemask 0x3FFFFFFFL
#define sizemask  typemask
...
int printhunk;
{
   while (true)
   {
      ...
      htype1 = htype & typemask;
      memtype = htype & memmask;
...
WrMemType(memtype)
long memtype;
{  writes( ((memtype == fastmem) ? "\004FAST" 
         :(memtype == chipmem) ? "\004CHIP"
