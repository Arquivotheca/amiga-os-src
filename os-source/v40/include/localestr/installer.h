...
#define MSG_PROB_SOURCE_STR "Problem with source file/drawer"

#define MSG_PROB_FILE 53
#define MSG_PROB_FILE_STR "Problem with file"

#define MSG_NOEXAMINE_OBJECT 97
#define MSG_NOEXAMINE_OBJECT_STR "Can't examine file or drawer"

#define MSG_NOEXIST_OBJECT 98
#define MSG_NOEXIST_OBJECT_STR "File or drawer doesn't exist"
...
#define MSG_CANNOT_CREATE_STR "Couldn't create directory"

#define MSG_CANNOT_COPY 124
#define MSG_CANNOT_COPY_STR "Couldn't copy a file"

#define MSG_OVERWRITE 125
#define MSG_OVERWRITE_STR "Tried to create drawer over a file"
