/* RMake (h/FLockercise_protos.h) Public Prototype generation (Version 4.2)
...
/* Prototypes for functions defined in c/GetFile.c */
BOOL GetFile(struct GlobalEnvironment *ge,
             char *hail);
