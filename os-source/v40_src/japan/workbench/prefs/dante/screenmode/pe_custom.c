...
struct EdGadget far EG[] = {
    {BUTTON_KIND,   8,   222,  90, 20, MSG_SAVE_GAD,           EC_SAVE,     0},
    {BUTTON_KIND,   254, 222,  90, 20, MSG_USE_GAD,            EC_USE,      0},
    {BUTTON_KIND,   501, 222,  90, 20, MSG_CANCEL_GAD,         EC_CANCEL,   0},

    {LISTVIEW_KIND,   8,  25,  306,108, MSG_SM_DISPLAY_MODE_GAD, EC_MODELIST,  0},
    {INTEGER_KIND,  106, 127,  60,  20, MSG_SM_WIDTH_GAD,        EC_WIDTH,     0},
    {INTEGER_KIND,  106, 148,  60,  20, MSG_SM_HEIGHT_GAD,       EC_HEIGHT,    0},
    {CHECKBOX_KIND, 182, 127,  90,  11, MSG_SM_DEFAULT_GAD,      EC_DEFWIDTH,  PLACETEXT_RIGHT},
    {CHECKBOX_KIND, 182, 148,  90,  11, MSG_SM_DEFAULT_GAD,      EC_DEFHEIGHT, PLACETEXT_RIGHT},
    {SLIDER_KIND,   138, 171,  166, 11, MSG_SM_COLORS_GAD,       EC_COLORS,    0},
    {CHECKBOX_KIND, 106, 186,  90,  11, MSG_SM_AUTOSCROLL_GAD,   EC_AUTOSCROLL,0}
};
...
UWORD            y;
    ...
    while (y < 200)
    {
        ...
        if (window->RPort->cp_x < 585+window->BorderLeft)
        {
            ...
            RectFill(window->RPort,window->RPort->cp_x,    y-16,
...
VOID RenderDisplay(EdDataPtr ed)
{
    ...
    CenterLine(ed,window->RPort,MSG_SM_PROPS_GAD,318,17,270);
    DrawBB(ed,318,25,270,180,GTBB_Recessed, TRUE,
