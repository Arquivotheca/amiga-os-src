...
#define PORT_NAME   "Input_Prefs"
#define ENV_NAME    "ENV:Sys/input.prefs"
#define ARC_NAME    "ENVARC:Sys/input.prefs"
...
typedef struct EdData
{
    ...
    struct InputPrefs     ed_PrefsDefaults;
    struct InputPrefs     ed_PrefsWork;
    struct InputPrefs     ed_PrefsInitial;
    ...
    struct Gadget        *ed_MouseSpeed;
    struct Gadget        *ed_Acceleration;
    struct Gadget        *ed_DoubleClick;
    struct Gadget        *ed_DoubleClickTest;
    struct Gadget        *ed_KeyDelay;
    struct Gadget        *ed_KeyRate;
    struct Gadget        *ed_KeyTest;
    struct Gadget        *ed_KeyboardType;

    BOOL                  ed_SampleClick;
    ULONG                 ed_SampleSeconds;
    ULONG                 ed_SampleMicros;

    struct List		  ed_AvailKeymaps;
    BOOL                  ed_FirstClick;
    ULONG                 ed_ClickSeconds;
    ULONG                 ed_ClickMicros;
    UWORD                 ed_IntuiCounter;
    struct KeyMapNode    *ed_Keymap;
} EdData;
