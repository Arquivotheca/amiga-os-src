...
struct ExtPrefs
{
    struct FontPrefs ep_WBFont;
    struct FontPrefs ep_SysFont;
    struct FontPrefs ep_ScreenFont;
};
...
typedef struct EdData
{
    ...
    struct Gadget        *ed_WBFont;
    struct Gadget        *ed_SysFont;
    struct Gadget        *ed_ScreenFont;
    struct FontRequester *ed_FontReq;
