...
{
    {BUTTON_KIND, 8, 132, BUTTON_WIDTH, 20, MSG_SAVE_GAD, EC_SAVE, 0},
    {BUTTON_KIND, 273, 132, BUTTON_WIDTH, 20, MSG_USE_GAD, EC_USE, 0},
    {BUTTON_KIND, NW_WIDTH-4-BUTTON_WIDTH, 132, BUTTON_WIDTH, 20, MSG_CANCEL_GAD, EC_CANCEL, 0},

    {CYCLE_KIND, 143, 4, 178, 18, MSG_WBP_PLACEMENT_GAD, EC_WHICH, 0},		/* Placement: */

    {BUTTON_KIND, 143, 92, 178, 20, MSG_WBP_TEST_GAD, EC_TEST, 0},		/* Test */

    {BUTTON_KIND, TOOL_LEFT, 94, 96, 20, MSG_WBP_CLEAR_GAD, EC_CLEAR, 0},	/* Clear */
    {BUTTON_KIND, TOOL_LEFT, 73, 96, 20, MSG_WBP_UNDO_GAD, EC_UNDO, 0},		/* Undo */
    {PALETTE_KIND, TOOL_LEFT, 4, 96, 66, NULL, EC_PALETTE, 0},

    {CYCLE_KIND, 143, 23, 178, 18, MSG_WBP_TYPE_GAD, EC_TYPE, 0},		/* Type: */

    {BUTTON_KIND, 143, 46, 178, 20, MSG_WBP_SELECT_PICTURE_GAD, EC_SELECT, 0},	/* Select Picture... */
    {TEXT_KIND, 143, 69, 178, 20, MSG_WBP_PICTURE_NAME_GAD, EC_NOP, 0},		/* Picture Name: */
};
