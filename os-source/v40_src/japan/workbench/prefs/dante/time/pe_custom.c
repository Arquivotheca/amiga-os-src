...
struct EdGadget far EG[] = {
    ...
    {BUTTON_KIND,   118, 195, 87,  20, MSG_USE_GAD,          EC_USE,     0},
    {BUTTON_KIND,   229, 195, 87,  20, MSG_CANCEL_GAD,       EC_CANCEL,  0},

    {INTEGER_KIND,  50,  4,   53,  20, MSG_NOTHING,          EC_YEAR,    0},
    {CYCLE_KIND,    138, 4,   178, 18, MSG_NOTHING,          EC_MONTH,   0},

    {SLIDER_KIND,   122, 140, 194, 11, MSG_TIME_HOURS_GAD,   EC_HOURS,   0},
    {SLIDER_KIND,   122, 156, 194, 11, MSG_TIME_MINUTES_GAD, EC_MINUTES, 0}
};

#define CALLEFT    8
#define CALTOP     25
#define CALWIDTH   311
#define CALHEIGHT  132

#define SAMPLELEFT   8
#define SAMPLETOP    172
#define SAMPLEWIDTH  308
#define SAMPLEHEIGHT 18
...
UWORD            len,plen,x;
    ...
    Move(rp,x,SAMPLETOP+15+window->BorderTop);
    Text(rp,sample,len);
