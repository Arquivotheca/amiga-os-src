...
{
    {BUTTON_KIND, 0, 0, 60, 20, MSG_SAVE_GAD, EC_SAVE, 0},	/* 0 : Save */
    {BUTTON_KIND, 0, 0, 60, 20, MSG_USE_GAD, EC_USE, 0},	/* 1 : Use */
    {BUTTON_KIND, 0, 0, 60, 20, MSG_CANCEL_GAD, EC_CANCEL, 0},	/* 2 : Cancel */

    {BUTTON_KIND, 0, 24, 118, 20, MSG_PTR_TEST_GAD, EC_TEST, 0},	/* 3 : Test */
    {BUTTON_KIND, 0, 45, 118, 20, MSG_PTR_CLEAR_GAD, EC_CLEAR, 0},	/* 4 : Clear */
    {BUTTON_KIND, 0, 67, 118, 20, MSG_PTR_SET_GAD, EC_SET, 0},	/* 5 : Set Grab Point */
    {BUTTON_KIND, 0, 89, 118, 20, MSG_PTR_RESET_GAD, EC_RESET, 0},	/* 6 : Reset */

    {PALETTE_KIND, 0, 112, 148, 40, NULL, EC_PALETTE, 0},	/* 7 : Palette */

    {SLIDER_KIND, 0, 156, 104, 11, MSG_PTR_RED_GAD, EC_RED, 0},	/* 8 : Red */
    {SLIDER_KIND, 0, 172, 104, 11, MSG_PTR_GREEN_GAD, EC_GREEN, 0},	/* 9 : Green */
    {SLIDER_KIND, 0, 188, 104, 11, MSG_PTR_BLUE_GAD, EC_BLUE, 0},	/* 10 : Blue  */

    {CYCLE_KIND, 0, 2, 100, 20, NULL, EC_TYPE, 0},	/* 11 : Type */
    {CYCLE_KIND, 0, 2, 148, 20, NULL, EC_SIZE, 0},	/* 12 : Size */
};
...
EdStatus InitEdData (EdDataPtr ed)
{
    ...
    ed->ed_ModeId = HIRES_KEY|LACE;
    ed->ed_SWidth = ed->ed_WWidth = 640;
    ed->ed_SHeight = ed->ed_WHeight = 380;

    /* Set the size for LORES */
    ed->ed_Width = 16;
    ed->ed_Height = 24;
    ed->ed_XMag = ed->ed_YMag = 12;
...
VOID CopyPrefs (EdDataPtr ed, struct ExtPrefs * dp, struct ExtPrefs * sp)
{
    ...
    bltbm (sp->ep_BMap, 0, 0,
	   dp->ep_BMap, 0, 10, (MAXWIDTH * 2), MAXHEIGHT,
