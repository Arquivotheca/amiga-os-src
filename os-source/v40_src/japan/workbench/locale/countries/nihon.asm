...
L011 DC.B   'J',0,0,0			; cp_CountryCode
L012 DC.L   81				; cp_TelephoneCode
...
;L017 PADSTR "%y/%m/%d %Q:%M %p",80	; cp_ShortDateTimeFormat
L017 PADSTR "%y年%m月%d日 %Q:%M %p",80	; cp_ShortDateTimeFormat
;L018 PADSTR "%y/%m/%d",40		; cp_ShortDateFormat
L018 PADSTR "%y年%m月%d日",40		; cp_ShortDateFormat
...
L034 PADSTR "YEN",10			; cp_MonIntCS
...
L043 DC.B   CT_7SUN			; cp_CalendarType
