...
LibName     DC.B "italiano.language",0
LibId       VSTRING
LibPriority EQU -100
...
Strings:
S000 DC.B       "",0
S001 DC.B	"Domenica",0
S002 DC.B	"Lunedì",0
S003 DC.B	"Martedì",0
S004 DC.B	"Mercoledì",0
S005 DC.B	"Giovedì",0
S006 DC.B	"Venerdì",0
S007 DC.B	"Sabato",0
...
S021 DC.B	"Luglio",0
S022 DC.B	"Agosto",0
S023 DC.B	"Settembre",0
S024 DC.B	"Ottobre",0
S025 DC.B	"Novembre",0
S026 DC.B	"Dicembre",0
