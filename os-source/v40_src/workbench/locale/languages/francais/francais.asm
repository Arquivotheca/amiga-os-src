...
LibName     DC.B "français.language",0
LibId       VSTRING
LibPriority EQU -100
...
S047 DC.B	"Hier",0        ; Yesterday
S048 DC.B	"Aujourd'hui",0	; Today
S049 DC.B	"Demain",0	; Tomorrow
S050 DC.B	"Futur",0	; Future
