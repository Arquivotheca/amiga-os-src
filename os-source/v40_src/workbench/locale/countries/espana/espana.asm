...
L011 DC.B   'E',0,0,0			; cp_CountryCode
L012 DC.L   34				; cp_TelephoneCode
L013 DC.B   MS_ISO			; cp_MeasuringSystem

L014 PADSTR "%e-%m-%y %H:%M:%S",80	; cp_DateTimeFormat
L015 PADSTR "%e-%m-%y",40		; cp_DateFormat
...
L032 PADSTR "Pesetas",10		; cp_MonCS
L033 PADSTR 0,10			; cp_MonSmallCS
L034 PADSTR "ESB",10			; cp_MonIntCS
