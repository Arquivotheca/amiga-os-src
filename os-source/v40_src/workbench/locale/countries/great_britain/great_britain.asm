...
L011 DC.B   'GB',0,0			; cp_CountryCode
L012 DC.L   44				; cp_TelephoneCode
L013 DC.B   MS_BRITISH			; cp_MeasuringSystem

L014 PADSTR "%A %e %B %Y  %H:%M",80	; cp_DateTimeFormat
L015 PADSTR "%A %e %B %Y",40		; cp_DateFormat
L016 PADSTR "%H:%M:%S",40		; cp_TimeFormat

L017 PADSTR "%d/%m/%y %H:%M",80		; cp_ShortDateTimeFormat
...
L033 PADSTR "p",10			; cp_MonSmallCS
L034 PADSTR "GPB",10			; cp_MonIntCS
...
L039 PADSTR 0,10			; cp_MonNegativeSign
L040 DC.B   SS_NOSPACE			; cp_MonNegativeSpaceSep
L041 DC.B   SP_PARENS			; cp_MonNegativeSignPos
