...
L011 DC.B   'F',0,0,0			; cp_CountryCode
L012 DC.L   33				; cp_TelephoneCode
L013 DC.B   MS_ISO			; cp_MeasuringSystem

L014 PADSTR "%A %e %B %Y %Hh%M",80	; cp_DateTimeFormat
L015 PADSTR "%A %e %B %Y",40		; cp_DateFormat
L016 PADSTR "%Hh%M",40			; cp_TimeFormat

L017 PADSTR "%d/%m/%y %Hh%M",80	; cp_ShortDateTimeFormat
L018 PADSTR "%d/%m/%y",40		; cp_ShortDateFormat
L019 PADSTR "%Hh%M",40			; cp_ShortTimeFormat
...
L031 DC.B   4				; cp_MonIntFracDigits

L032 PADSTR "F",10			; cp_MonCS
L033 PADSTR 0,10			; cp_MonSmallCS
L034 PADSTR "FRF",10			; cp_MonIntCS
