...
L011 DC.B   'PO',0,0			; cp_CountryCode
L012 DC.L   351				; cp_TelephoneCode
L013 DC.B   MS_ISO			; cp_MeasuringSystem

L014 PADSTR "%A, %e de %B de %Y, %H:%M:%S",80	; cp_DateTimeFormat
L015 PADSTR "%A, %e de %B de %Y",40		; cp_DateFormat
...
L032 PADSTR "ESP",10			; cp_MonCS
L033 PADSTR 0,10			; cp_MonSmallCS
L034 PADSTR 0,10			; cp_MonIntCS

L035 PADSTR "+",10			; cp_MonPositiveSign
