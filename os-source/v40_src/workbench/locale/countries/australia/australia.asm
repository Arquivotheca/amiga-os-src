...
L011 DC.B   'AUS',0			; cp_CountryCode
L012 DC.L   61				; cp_TelephoneCode
L013 DC.B   MS_ISO			; cp_MeasuringSystem

L014 PADSTR "%A %B %e %Y %I:%M%p",80	; cp_DateTimeFormat
L015 PADSTR "%A %B %e %Y",40		; cp_DateFormat
L016 PADSTR "%I:%M:%S%p",40		; cp_TimeFormat

L017 PADSTR "%e/%m/%y %I:%M%p",80	; cp_ShortDateTimeFormat
L018 PADSTR "%e/%m/%y",40		; cp_ShortDateFormat
L019 PADSTR "%I:%M%p",40			; cp_ShortTimeFormat
...
L034 PADSTR "AUD",10			; cp_MonIntCS
