...
TRANS_HEADER_STR: DC.B '******* Installation Log *******',10,'User Level: %s',10,'Pretend: %s',10,0
TRANS_USER_DRAWER_STR: DC.B 'User made a new drawer: "%s".',0
TRANS_COPY_FILE_STR: DC.B 'Copy file "%s" to "%s".',0
TRANS_COPY_DRAWER_STR: DC.B 'Copy contents of drawer "%s" to "%s".',0
TRANS_ASK_CHOICE_STR: DC.B 'Ask Choice: User selected "%s".',0
TRANS_NO_OPTIONS_STR: DC.B 'Ask Options: User selected no options.',0
TRANS_ASK_OPTIONS_STR: DC.B 'Ask Options: User selected following options...',0
TRANS_ASK_STRING_STR: DC.B 'Ask String: Result was "%s".',0
TRANS_ASK_NUMBER_STR: DC.B 'Ask Number: Result was "%ld".',0
TRANS_ASK_BOOL_STR: DC.B 'Ask Question: Result was "%s".',0
TRANS_DEST_DRAWER_STR: DC.B 'User changed Copy Files destination drawer to "%s".',0
TRANS_ASK_DRAWER_STR: DC.B 'Ask Drawer: Result was "%s".',0
TRANS_ASK_FILE_STR: DC.B 'Ask File: Result was "%s".',0
MSG_ONERROR_STR: DC.B '*** Global error -- executing onerror statements ***',0
MSG_USER_ABORT_STR: DC.B 'User aborted!',10,0
MSG_ABORT_LINE_STR: DC.B 'Script aborted in line %ld.',0
MSG_PROBLEM_LINE_STR: DC.B '%s in line %ld.',0
TRANS_CREATE_DRAWER_STR: DC.B 'Create New Directory: "%s"',0
TRANS_INSERT_COMMANDS_STR: DC.B 'Insert commands to Execute "%s" in file "%s" at byte %ld.',0
TRANS_CREATE_TEXTFILE_STR: DC.B 'Create Text File: "%s"',10,'================== Start of textfile =========='
	DC.B '========',0
TRANS_END_TEXTFILE_STR: DC.B '=================== End of textfile ===================',0
TRANS_EXECUTE_STR: DC.B 'Execute DOS Script: "%s"',0
TRANS_RUN_STR: DC.B 'Run Program: "%s"',0
TRANS_AREXX_STR: DC.B 'Execute ARexx Script: "%s"',0
TRANS_RENAME_STR: DC.B 'Renamed "%s" to "%s"',0
TRANS_DELETE_STR: DC.B 'Delete file "%s"',0
TRANS_ABORTING_STR: DC.B 'Aborting script.',0
TRANS_EXITING_STR: DC.B 'Exiting script...',0
TRANS_START_US_STR: DC.B 'Writing to %s',10,'==================== start of file ====================',0
TRANS_END_US_STR: DC.B '===================== end of file =====================',0
...
TX_USAGE_STR: DC.B 'USAGE: installer [SCRIPT] filename <[APPNAME] name> <[MINUSER] level>',10
	DC.B '       <[DEFUSER] default> <[LOGFILE] logname> <NOPRETEND> <NOLOG>',0
