...
#define PORT_NAME   "IControl_Prefs"
...
typedef struct EdData
{
    ...
    struct IControlPrefs  ed_PrefsDefaults;
    struct IControlPrefs  ed_PrefsWork;
    struct IControlPrefs  ed_PrefsInitial;
    ...
    struct Gadget        *ed_Shift;
    struct Gadget        *ed_Ctrl;
    struct Gadget        *ed_Alt;
    struct Gadget        *ed_Amiga;
    struct Gadget        *ed_AvoidFlicker;
    struct Gadget        *ed_PreserveColors;
    struct Gadget        *ed_MenuSnap;
    struct Gadget        *ed_GadgetFilter;
    struct Gadget        *ed_ModePromote;
} EdData;
