 ...
 */
#define CE_NAME         MSG_CD_NAME
#define CE_TITLE        MSG_CD_TITLE
#define CE_DESCRIPTION  MSG_CD_DESCRIPTION
#define CE_PRIORITY     0
#define CE_POPKEY       "control alt c"
...
#define WINDOW_TOP    0
#define WINDOW_WIDTH  317
#define WINDOW_HEIGHT 64

#define IDCMPFLAGS  BUTTONIDCMP | CHECKBOXIDCMP | STRINGIDCMP | LISTVIEWIDCMP | IDCMP_CLOSEWINDOW | IDCMP_REFRESHWINDOW | IDCMP_MENUPICK | IDCMP_DISKINSERTED
