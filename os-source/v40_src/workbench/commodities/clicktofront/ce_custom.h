...
#include "clicktofront_rev.h"

#define CX_CLICKTOFRONT
 ...
 */
#define TEMPLATE      "CX_PRIORITY/N/K,QUALIFIER/K" VERSTAG
#define OPT_PRIORITY  0
#define OPT_QUALIFIER 1
#define OPT_POPKEY    2
#define OPT_POPUP     2
#define OPT_COUNT     3
 ...
 */
#define CE_NAME         MSG_CTF_NAME
#define CE_TITLE        MSG_CTF_TITLE
#define CE_DESCRIPTION  MSG_CTF_DESCRIPTION
