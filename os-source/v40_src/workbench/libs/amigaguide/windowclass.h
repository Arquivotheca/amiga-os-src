...
#define	WOA_VisualInfo	(WOA_Dummy + 0)
...
#define	WOA_TextAttr	(WOA_Dummy + 9)
...
#define	WOA_InnerWidth	(WOA_Dummy + 12)
#define	WOA_Sync	(WOA_Dummy + 13)
...
#define	GID_CONTENTS	2
#define	GID_INDEX	3
#define	GID_HELP	4
#define	GID_RETRACE	5
#define	GID_BROWSEP	6
#define	GID_BROWSEN	7
#define	GID_MAX		8
