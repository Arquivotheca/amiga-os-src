*
* $Id: decbin.asm,v 0.1 91/06/26 09:01:40 mks Exp $
*
* $Log:	decbin.asm,v $
* Revision 0.1  91/06/26  09:01:40  mks
* Initial check in...
* 
*
...
;	btst	#31,(a0)	;test sign of the mantissa
	btst.b	#7,(a0)		;test sign of the mantissa
...
;	btst	#30,(a0)	;test the sign of the exponent
	btst.b	#6,(a0)		;test the sign of the exponent
