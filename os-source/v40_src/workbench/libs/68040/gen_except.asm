*
* $Id: gen_except.asm,v 0.2 91/07/03 10:25:57 mks Exp $
*
* $Log:	gen_except.asm,v $
* Revision 0.2  91/07/03  10:25:57  mks
* First pass at doing branch optimizations
* 
* Revision 0.1  91/06/26  09:01:22  mks
* Initial check in...
*
*
...
commonE1:
	...
	bra.s	commonE			;go clean and exit
...
*	move.w	#$fe,CU_SAVEPC(a6)
	...
	bclr.b	#UFLAG,T_BYTE(a6)	;clr U flag from unimp
	bra.s	do_clean		;go clean and exit
