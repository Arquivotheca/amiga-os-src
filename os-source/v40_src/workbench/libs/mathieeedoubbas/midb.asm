...
*	transfer double from fp0 to d0/d1
...
IOMIIEEEDPAdd
	SETUP
*	transfer double from d0/d1 to fp0
;	move.w	#fmvtofp+fp0,command(a0)
	NULCA1	#fmvtofp+fp0
	move.l	d0,(a1)
	move.l	d1,(a1)
...
;	move.w	#fmvtocr+fpcr,command(a0)
	NULCA1	#fmvtocr+fpcr
	ifd	ALLOW_TRAPS
	move.l	#$00001490,(a1)		; round to 0, chop mode
					; trigger exception on div0,ovfl
	endc
	ifnd	ALLOW_TRAPS
	move.l	#$00000090,(a1)		; round to 0, chop mode
	endc
	NULREL
	clr.l	d0
	SHUTDOWN
