 ...
 *
 *	To enable compilation of the macro expansions define the
 ...
 */
    ...
    extern int _db_keyword_ PROTO((char *));
    extern void _db_push_ PROTO((char*));
    extern void _db_pop_ PROTO((void));
    extern void _db_enter_ PROTO((char *, char *, int, char **, char **, int *,
				 char ***));
    extern void _db_return_ PROTO((int, char **, char **, int *));
    extern void _db_pargs_ PROTO((int, char *));
#if NO_VARARGS
    extern void _db_doprnt_ PROTO((char *, ARGS_TYPE));
#else
    extern void _db_doprnt_ PROTO((char *,...));
#endif
