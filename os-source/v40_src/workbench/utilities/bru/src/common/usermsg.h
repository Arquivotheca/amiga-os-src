 ...
 *  FILE
 *
 *	usermsg.h    message code definitions
 *
 *  SCCS
 *
 *	@(#)usermsg.h	12.8	11 Feb 1991
 *
 *  SYNOPSIS
 *
 *	#include "usermsg.h"
...
#define MSG_STATFAIL	13	/* Can't stat file */
...
#define MSG_BSZCHG	83	/* Attempt to change buffer size on nth vol */
...
#define MSG_NOSHRINK	87	/* Compressed version was larger, saved uncompressed */
...
#define MSG_ZFAILED	91	/* Compression failed for some nonspecific reason */
...
#define MSG_NSEGS	99	/* Need at least two shared memory regions */
...
#define MSG_SHMCOPY	106	/* Warn that device may need shmcopy in brutab */
...
#define MSG_FBIOERR	130	/* IO error on first block */
#define MSG_IGNCLOSE	131	/* Device may need ignoreclose flag set */
#define MSG_ADJMSIZE	132	/* Adjusted media size to given Kb */
#define MSG_NOENTRY	133	/* No brutab entry for b/c-special device */
#define MSG_SELFCHK	134	/* Fails simple self checks */
#define MSG_BRUPATHMAX	135	/* Unknown length name too big */
#define MSG_LBROKEN	136	/* Link broken, saved as duplicate */
#define MSG_WAITFAIL	137	/* Wait returned -1 for some unknown reason */
