;Lacer is a special version of SetLace which only toggles interlace if
;a genlock is detected.
;
...
;to INTERLACE and turn tricks like disabling colorburst.
;
...
clear		andi.w	#$ffff-INTERLACE,gb_system_bplcon0(a6)  ;Clear lace
		bra.s	break
flip		btst.b	#GENLOCn,gb_DisplayFlags+1(a6)		;Genlock?
		beq.s	break
		eori.w	#INTERLACE,gb_system_bplcon0(a6)        ;Flip lace
