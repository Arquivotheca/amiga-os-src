	TTL    '$Header: V38:src/workbench/devs/printer/toshiba_p351sx/RCS/init.asm,v 1.1 90/04/09 09:13:29 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: V38:src/workbench/devs/printer/toshiba_p351sx/RCS/init.asm,v 1.1 90/04/09 09:13:29 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.1  90/04/09  09:13:29  daveb
*   for rcs 4.x header change
*   
*   Revision 1.0  88/04/10  12:56:41  daveb
*   added to rcs
*   
*   Revision 1.0  88/03/16  15:21:58  daveb
*   added to rcs
*   
