/*
	Data.c table for Toshiba_P351SX driver.
...
char *CommandTable[] ={
	...
	"\033~S011",	/* 27 aSUS2 superscript on		*/
	"\033~S010",	/* 28 aSUS1 superscript off		*/
	"\033~S012",	/* 29 aSUS4 subscript on		*/
	"\033~S010",	/* 30 aSUS3 subscript off		*/
	"\033~S010",	/* 31 aSUS0 normalize the line		*/
...
char *ExtendedCharTable[] = {
	...
	"\276", "\253", "a", "<",
	"~", "-", "\252", "-",
	"\246", "+\010_", "\033~S0112\033~S010", "\033~S0113\033~S010",
	"\240", "\245", "\257", ".",
	",", "\033~S0111\033~S010", "\246\010-", ">",
	"\254", "\256", "\255", "?",
