**********************************************************************
*
* Transfer routine for Howtek_Pixelmaster
*
...
black:
	...
	bclr.b	d7,0(a4,d0.w)		;clear cyan pixel
	bclr.b	d7,0(a5,d0.w)		;clear magenta pixel
	bclr.b	d7,0(a6,d0.w)		;clear yellow pixel
	bra.s	csx_end
