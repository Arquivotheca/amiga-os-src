	TTL    '$Header: V38:src/workbench/devs/printer/colormaster2/RCS/init.asm,v 1.1 90/04/06 19:58:06 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: V38:src/workbench/devs/printer/colormaster2/RCS/init.asm,v 1.1 90/04/06 19:58:06 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.1  90/04/06  19:58:06  daveb
