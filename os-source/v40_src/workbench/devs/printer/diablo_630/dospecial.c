/* diablo 630 special printer functions */

/****** printer.device/printers/Diablo_630_special_functions ************
 *
 *   NAME
 *   Diablo 630 special functions implemented:
 * 
 ************************************************************************/
   ...
   UBYTE Parms[];
{
    ...
    static char initThisPrinter[]="\033\037\015\033\036\011\033&\033R\015";
