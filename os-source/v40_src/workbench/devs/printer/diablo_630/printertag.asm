	TTL    '$Header: printertag.asm,v 1.1 87/09/08 11:39:00 daveb Exp $'
**********************************************************************
*                                                                    *
...
*   Source Control
*   --------------
*   $Header: printertag.asm,v 1.1 87/09/08 11:39:00 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	printertag.asm,v $
*   Revision 1.1  87/09/08  11:39:00  daveb
*   reserved space for PrintMode and added null ptr to char conversion function.
*   
*   Revision 1.0  87/08/20  14:02:06  daveb
*   added to rcs
*   
*   Revision 1.0  87/08/20  13:24:39  daveb
*   added to rcs
*   
