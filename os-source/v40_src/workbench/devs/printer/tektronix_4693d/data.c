/************************************************************************
 *
 * Data.c   -  Tektronix 4693D   -  Bill Koester (CATS)
 *
 * Copyright 1987 Commodore International Ltd.
 *
 ************************************************************************/
 ...
 *
 *   NAME
 *   Tektronix 4693D functions implemented:
 *
 *       None. Graphics only printer!
 *
...
/*********************************************************************
 *
 * Character conversion function - Graphics only printer!
 *
 *********************************************************************/
ConvFunc(buf, c, flag)
char *buf, c;
