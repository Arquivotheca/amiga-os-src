	TTL    '$Id: init.asm,v 1.2 90/08/29 12:41:25 darren Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Id: init.asm,v 1.2 90/08/29 12:41:25 darren Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.2  90/08/29  12:41:25  darren
*   Change $Header to Id$
*   
*   Revision 1.1  90/04/06  20:06:51  daveb
*   for rcs 4.x header change
*   
*   Revision 1.0  88/04/05  04:55:27  daveb
*   added to rcs
*   
