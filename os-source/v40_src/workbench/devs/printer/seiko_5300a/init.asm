	TTL    '$Header: V38:src/workbench/devs/printer/seiko_5300a/RCS/init.asm,v 1.1 90/04/09 09:05:08 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: V38:src/workbench/devs/printer/seiko_5300a/RCS/init.asm,v 1.1 90/04/09 09:05:08 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.1  90/04/09  09:05:08  daveb
