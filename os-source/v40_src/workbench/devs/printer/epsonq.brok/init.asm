	TTL    '$Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/epsonQ/RCS/init.asm,v 1.0 87/08/20 14:08:30 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/epsonQ/RCS/init.asm,v 1.0 87/08/20 14:08:30 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
