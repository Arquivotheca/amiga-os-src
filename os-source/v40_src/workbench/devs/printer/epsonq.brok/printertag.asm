	TTL    '$Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/epsonQ/RCS/printertag.asm,v 1.5 88/04/19 17:12:34 daveb Exp $'
**********************************************************************
*                                                                    *
...
*   Source Control
*   --------------
*   $Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/epsonQ/RCS/printertag.asm,v 1.5 88/04/19 17:12:34 daveb Exp $
*
*   $Locker:  $
*
