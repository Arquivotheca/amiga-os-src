	TTL    '$Header: /usr.MC68010/ghostwheel/darren/V38/printer/epsonXOld/RCS/init.asm,v 1.2 91/07/10 16:43:42 darren Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: /usr.MC68010/ghostwheel/darren/V38/printer/epsonXOld/RCS/init.asm,v 1.2 91/07/10 16:43:42 darren Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.2  91/07/10  16:43:42  darren
