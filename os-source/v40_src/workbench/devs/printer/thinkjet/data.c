/*
	Data.c table for HP_ThinkJet driver.
...
char *CommandTable[] ={
	...
	"\033(s1B",	/* 10 aSGR1 boldface on			*/
	"\033(s0B",	/* 11 aSGR22 boldface off		*/
	"\377",		/* 12 aSFC set foreground color		*/
	"\377",		/* 13 aSBC set background color		*/

	"\033&k0S",	/* 14 aSHORP0 normal pitch		*/
	"\377",		/* 15 aSHORP2 elite on			*/
	"\377",		/* 16 aSHORP1 elite off			*/
	"\033&k2S",	/* 17 aSHORP4 condensed fine on		*/
	"\033&k0S",	/* 18 aSHORP3 condensed fine off	*/
	"\033&k1S",	/* 19 aSHORP6 enlarge on		*/
	"\033&k0S",	/* 20 aSHORP5 enlarge off		*/
	...
	"\033&l0L",	/* 59 aPERF0 perf skip off		*/
