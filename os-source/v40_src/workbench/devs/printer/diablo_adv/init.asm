	TTL    '$Header: init.asm,v 1.0 87/08/20 14:04:09 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: init.asm,v 1.0 87/08/20 14:04:09 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.0  87/08/20  14:04:09  daveb
*   added to rcs
*   
*   Revision 1.1  85/10/09  19:27:00  kodiak
*   remove _stdout variable
*   
*   Revision 1.0  85/10/09  19:22:49  kodiak
