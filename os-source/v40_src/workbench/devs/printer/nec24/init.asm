	TTL    '$Header: /usr.MC68010/ghostwheel/darren/V38/printer/nec24/RCS/init.asm,v 1.2 91/07/09 10:03:49 darren Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: /usr.MC68010/ghostwheel/darren/V38/printer/nec24/RCS/init.asm,v 1.2 91/07/09 10:03:49 darren Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.2  91/07/09  10:03:49  darren
*   No change
*   
*   Revision 1.1  90/04/06  20:10:52  daveb
*   for rcs 4.x header change
*   
*   Revision 1.0  88/03/11  13:32:07  daveb
*   added to rcs
*   
*   Revision 1.0  87/08/20  14:08:30  daveb
*   added to rcs
*   
