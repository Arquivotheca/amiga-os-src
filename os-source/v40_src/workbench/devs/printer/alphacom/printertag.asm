	TTL    '$Header: printertag.asm,v 1.1 87/09/08 11:37:57 daveb Exp $'
**********************************************************************
*                                                                    *
...
*   Source Control
*   --------------
*   $Header: printertag.asm,v 1.1 87/09/08 11:37:57 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	printertag.asm,v $
*   Revision 1.1  87/09/08  11:37:57  daveb
*   reserved space for PrintMode and added null ptr to char conversion function.
*   
*   Revision 1.0  87/08/20  13:20:10  daveb
*   added to rcs
*   
*   Revision 32.4  86/06/30  21:04:28  andy
*   enabled 8 bit character support
*   
*   Revision 32.3  86/06/30  20:49:59  andy
*   *** empty log message ***
*   
*   Revision 32.2  86/06/10  12:53:39  andy
*   Corrected printer name
*   
*   Revision 32.1  86/02/10  14:31:22  kodiak
*   add null 8BitChars field
*   
*   Revision 32.0  86/02/10  14:20:28  kodiak
*   added to rcs for updating
*   
*   Revision 1.1  85/10/09  23:55:53  kodiak
*   replace reference to pdata w/ prtbase
*   
*   Revision 1.0  85/10/09  23:55:47  kodiak
