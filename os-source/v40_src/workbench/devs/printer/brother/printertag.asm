	TTL    '$Header: printertag.asm,v 1.1 87/09/08 11:38:45 daveb Exp $'
**********************************************************************
*                                                                    *
...
*   Source Control
*   --------------
*   $Header: printertag.asm,v 1.1 87/09/08 11:38:45 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	printertag.asm,v $
*   Revision 1.1  87/09/08  11:38:45  daveb
*   reserved space for PrintMode and added null ptr to char conversion function.
*   
*   Revision 1.0  87/08/20  13:54:50  daveb
*   added to rcs
*   
*   Revision 1.0  87/08/20  13:21:24  daveb
*   added to rcs
*   
*   Revision 32.4  86/06/30  21:05:08  andy
*   *** empty log message ***
*   
*   Revision 32.3  86/06/30  20:50:27  andy
*   fixed 8bit char support
*   
*   Revision 32.2  86/06/10  12:55:06  andy
*   Corrected printer name
*   
*   Revision 32.1  86/02/10  14:31:44  kodiak
*   add null 8BitChars field
*   
*   Revision 32.0  86/02/10  14:20:59  kodiak
*   added to rcs for updating
*   
*   Revision 1.1  85/10/09  23:56:10  kodiak
*   replace reference to pdata w/ prtbase
*   
*   Revision 1.0  85/10/09  23:56:04  kodiak
