	TTL    '$Header: init.asm,v 1.0 87/08/20 13:54:35 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: init.asm,v 1.0 87/08/20 13:54:35 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.0  87/08/20  13:54:35  daveb
*   added to rcs
*   
*   Revision 1.1  85/10/09  19:26:42  kodiak
*   remove _stdout variable
*   
*   Revision 1.0  85/10/09  19:22:13  kodiak
