	TTL    '$Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/generic/RCS/init.asm,v 1.1 90/04/06 20:05:46 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/generic/RCS/init.asm,v 1.1 90/04/06 20:05:46 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
