	TTL    '$Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/generic/RCS/printertag.asm,v 1.1 90/04/06 20:05:51 daveb Exp $'
**********************************************************************
*                                                                    *
...
*   Source Control
*   --------------
*   $Header: /usr/machines/heartofgold/amiga/V37/src/workbench/devs/printer/generic/RCS/printertag.asm,v 1.1 90/04/06 20:05:51 daveb Exp $
*
*   $Locker:  $
*
