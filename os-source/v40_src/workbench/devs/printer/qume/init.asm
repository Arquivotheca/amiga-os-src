	TTL    '$Header: init.asm,v 1.0 87/08/20 13:51:19 daveb Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: init.asm,v 1.0 87/08/20 13:51:19 daveb Exp $
*
*   $Locker:  $
*
*   $Log:	init.asm,v $
*   Revision 1.0  87/08/20  13:51:19  daveb
*   added to rcs
*   
*   Revision 1.0  87/08/20  11:46:10  daveb
*   added to rcs
*   
*   Revision 1.1  85/10/09  19:27:57  kodiak
*   remove _stdout variable
*   
*   Revision 1.0  85/10/09  19:24:24  kodiak
