	TTL    '$Header: dk.asm,v 36.0 89/05/25 16:53:13 eric Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: dk.asm,v 36.0 89/05/25 16:53:13 eric Exp $
*
*   $Locker:  $
*
*   $Log:	dk.asm,v $
*   Revision 36.0  89/05/25  16:53:13  eric
*   Initial Submission
*   
*   
*
...
*							    0F      3C
*
*   `~	1!  2"	3#  4o	5%  6&	7/  8(	9) 0=  +?  '`  \|   [{  ]}  /   *
*	  qQ  wW  eE  rR  tT  yY  uU  iI  oO  pP  aA  ^     7   8   9   -
*	   aA  sS  dD  fF  gG  hH  jJ  kK  lL  ae  00  '*   4   5   6   +
*	 <>  zZ	 xX  cC	 vV  bB	 nN  mM	 ,;  .:	 -_	    1   2   3   enter
*							    0       .
*
*---------------------------------------------------------------------
*
...
*---------------------------------------------------------------------
DKLCapsable:
		DC.B	%00000000,%00000000,%11111111,%00000111
		DC.B	%11111111,%00000111,%11111110,%00000000
...
DKLowMap:
		...
		DC.B	'{','[',$C5,$E5	; angstrom, Angstrom, [, { / Vanilla
...
key0C:
		...
		DC.B	0,'=',0,'+'		; =, +
key1B:
		DC.B	DPF_DEAD,5,DPF_DEAD,3	; dead ", dead ^
		DC.B	0,']',0,'}'		; ], }
