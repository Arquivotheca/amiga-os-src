	TTL    '$Header: ch2.asm,v 36.0 89/05/25 16:49:26 eric Exp $'
**********************************************************************
*								     *
...
**********************************************************************
*
*   CH2:  SWISS KeyMap #2	(A2000)
*
*   Source Control
*   --------------
*   $Header: ch2.asm,v 36.0 89/05/25 16:49:26 eric Exp $
*
*   $Locker:  $
*
*   $Log:	ch2.asm,v $
*   Revision 36.0  89/05/25  16:49:26  eric
*   Initial Submission
*   
*   
*
...
*	  qQ  wW  eE  rR  tT  zZ  uU  iI  oO  pP  ue  "!    7   8   9   -
*	   aA  sS  dD  fF  gG  hH  jJ  kK  lL  oe  aa  $L   4   5   6   +
...
CH1LowMap:
	...
	DC.B	'{','[',$E8,$FC	; umlaut-u, grave-e, [, { / Vanilla
	...
	DC.B	':',';',$E9,$F6 ; umlaut-o, aigu-e, ;, :
	DC.B	'"',$27,$E0,$E4 ; umlaut-a, grave-a, ', "
	DC.B	0,0,$A3,'$'	; $, pound
	DC.L	0		; NOP
	DC.B	0,0,0,'4'	; 4
	DC.B	0,0,0,'5'	; 5
