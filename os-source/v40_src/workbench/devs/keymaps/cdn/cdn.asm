	TTL    '$Header: cdn.asm,v 36.0 89/05/25 15:34:05 eric Exp $'
**********************************************************************
*								     *
...
**********************************************************************
*
*   FRENCH-CANADIAN	(A2000)
*
*   Source Control
*   --------------
*   $Header: cdn.asm,v 36.0 89/05/25 15:34:05 eric Exp $
*
*   $Locker:  $
*
*   $Log:	cdn.asm,v $
*   Revision 36.0  89/05/25  15:34:05  eric
*   Initial Submission
*   
*   
*
...
*							    0F      3C
*
*   \|	1!  2"	3#  4$	5%  6&	7/  8'	9( 0)  -_  =+  "~   @{	o}  /   *
*	  qQ  wW  eE  rR  tT  yY  uU  iI  oO  pP  [<<  ]>>  7	8   9   -
*	   aA  sS  dD  fF  gG  hH  jJ  kK  lL  ;:  `^  ?*   4   5   6   +
*	 EC  zZ	 xX  cC	 vV  bB	 nN  mM	 ,<  .>	 ec	    1   2   3   ent
*							    0       .
*
*---------------------------------------------------------------------
*
...
CDNLowMap:
		...
		DC.B	'&',$BE,'/','7'	; 7, /, 3/4, &
		DC.B	'*',$B7,$27,'8'	; 8, ', bullet, *
		DC.B	'(',$AB,'(','9'	; 9, (, <<, (
		DC.B	')',$BB,')','0'	; 0, ), >>, )
		DC.B	'_','-','_','-'	; -, _ / Vanilla
		DC.B	'+','=','+','='	; =, +
		DC.L	key0D		; dead ", ~, \, | / Vanilla
		DC.L	0
		...
		DC.B	$BB,$AB,$C7,$C9	; accented E, C cedilla, , >, <<, >>
		...
		DC.B	'<',',','<',','	; ,, <
		DC.B	'>','.','>','.'	; ., >
		DC.B	'?','/',$E7,$E9	; accented e, c cedilla, /, ?
		DC.L	0
...
key0D:
		DC.B	DPF_DEAD,5,0,'~'	; dead ", ~
		DC.B	0,'\',0,'|'		; \, |
		DC.B	0,$1C,0,$1C,0,$9C,0,$9C	; control translation
key2A:
