	TTL    '$Header: is.asm,v 36.0 89/05/25 17:00:52 eric Exp $'
**********************************************************************
*								     *
...
*   Source Control
*   --------------
*   $Header: is.asm,v 36.0 89/05/25 17:00:52 eric Exp $
*
*   $Locker:  $
*
*   $Log:	is.asm,v $
*   Revision 36.0  89/05/25  17:00:52  eric
*   Initial Submission
*   
*   
*
...
*
*   `~	1!  2"	3#  4o	5%  6&	7/  8(	9) 0=  oO  -_  \|   7	8   9
*	  qQ  wW  eE  rR  tT  yY  uU  iI  oO  pP  dD  '?    4	5   6
*	   aA  sS  dD  fF  gG  hH  jJ  kK  lL  AE  '"  +*   1   2   3
*	 <>  zZ	 xX  cC	 vV  bB	 nN  mM	 ,;  .:	 pP	    0	    .
*
*
*---------------------------------------------------------------------
*
...
*---------------------------------------------------------------------
ICLCapsable:
		DC.B	%00000000,%00001000,%11111111,%00000111
		DC.B	%11111111,%00000011,%11111110,%00000100
