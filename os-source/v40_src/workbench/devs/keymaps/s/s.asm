	TTL    '$Header: s.asm,v 36.0 89/05/25 17:04:02 eric Exp $'
**********************************************************************
*								     *
...
**********************************************************************
*
*   SWEDEN/FINLAND key map
*
*   Source Control
*   --------------
*   $Header: s.asm,v 36.0 89/05/25 17:04:02 eric Exp $
*
*   $Locker:  $
*
*   $Log:	s.asm,v $
*   Revision 36.0  89/05/25  17:04:02  eric
*   Initial Submission
*   
*   
*
...
*
*   `~	1!  2"	3L  4$	5%  6&	7/  8(	9) 0=  +?  `'  *^   7	8   9
*	  qQ  wW  eE  rR  tT  yY  uU  iI  oO  pP  aA  "^    4	5   6
*	   aA  sS  dD  fF  gG  hH  jJ  kK  lL  oO  aA  uU   1   2   3
*	 <>  zZ	 xX  cC	 vV  bB	 nN  mM	 ,;  .:	 -_	    0	    .
*
*
*---------------------------------------------------------------------
*
