...
**********************************************************************
*
*   BRITISH key map for A2500 and B52
*
**********************************************************************
...
*	
*---------------------------------------------------------------------
BMLCapsable: ; NL means NULL (undefined) and RE means RESERVED
	DC.B	%00000000 ; 7& 6^ 5% 4$ 3L 2" 1! `o  07 - 00
	DC.B	%00000000 ; 0N NL \| =+ -_ 0) 9( 8*  0F - 08
	DC.B	%11111111 ; iI uU yY tT rR eE wW qQ  17 - 10
	DC.B	%00000011 ; 3N 2N 1N NL ]} [{ pP oO  1F - 18
	DC.B	%11111111 ; kK jJ hH gG fF dD sS aA  27 - 20
	DC.B	%00000001 ; 6N 5N 4N NL RE '@ ;: lL  2F - 28
	DC.B	%11111110 ; mM nN bB vV cC xX zZ RE  37 - 30
...
BMLRepeatable:
	DC.B	%11111111 ; 7& 6^ 5% 4$ 3L 2" 1! `o  07 - 00
	DC.B	%10111111 ; 0N NL \| =+ -_ 0) 9( 8*  0F - 08
	DC.B	%11111111 ; iI uU yY tT rR eE wW qQ  17 - 10
	DC.B	%11101111 ; 3N 2N 1N NL ]} [{ pP oO  1F - 18
	DC.B	%11111111 ; kK jJ hH gG fF dD sS aA  27 - 20
	DC.B	%11101111 ; 6N 5N 4N NL RE '@ ;: lL  2F - 28
	DC.B	%11111111 ; mM nN bB vV cC xX zZ RE  37 - 30
...
BMLowMapType:
	DC.B	KC_VANILLA,KCF_SHIFT+KCF_ALT ; `degree 1!
	DC.B	KC_VANILLA,KCF_SHIFT+KCF_ALT ; 2" 3pound
	...
	DC.B	KCF_SHIFT+KCF_ALT,KC_VANILLA ; 0) -_
	...
	DC.B	KCF_NOP,KC_NOQUAL,KC_NOQUAL,KC_NOQUAL ; NL 1N 2N 3N
	...
	DC.B	KC_VANILLA,KCF_SHIFT+KCF_ALT ; lL ;:
	DC.B	KC_VANILLA,KCF_NOP ; '@ NL
	DC.B	KCF_NOP,KC_NOQUAL,KC_NOQUAL,KC_NOQUAL ; NL 4N 5N 6N

	DC.B	KCF_NOP,KC_VANILLA,KC_VANILLA,KC_VANILLA ; NL zZ xX cC
	DC.B	KC_VANILLA,KC_VANILLA ; vV bB
	DC.B	KCF_DEAD+KC_VANILLA ; nN
	DC.B	KC_VANILLA,KCF_SHIFT+KCF_ALT,KCF_SHIFT+KCF_ALT ; mM ,< .>
	DC.B	KCF_SHIFT+KCF_ALT,KCF_NOP ; /? NL
	DC.B	KC_NOQUAL,KC_NOQUAL,KC_NOQUAL,KC_NOQUAL ; .N 7N 8N 9N
...
BMLowMap: ;                                            KEYCODES
	...
	DC.B	'@',$B2,'"','2'	; 2, ", super 2, @             02
	DC.B	'#',$B3,$A3,'3'	; 3, pound, super 3, #         03
	DC.B	'$',$A2,'$','4'	; 4, $, cents, $               04
	DC.B	'%',$BC,'%','5'	; 5, %, 1/4, %                 05
	DC.B	'^',$BD,'^','6'	; 6, ^, 1/2, ^                 06
	DC.B	'&',$BE,'&','7'	; 7, &, 3/4, &                 07
	...
	DC.B	$BF,$B8,'M','m'	; m, M, cedilla, inverted ? / Vanilla 37
	DC.B	'<',',','<',','	; ,, <, ,, <                   38
	DC.B	'>','.','>','.'	; ., >, ., >                   39
	DC.B	'?','/','?','/'	; /, ?. /, ?                   3A
	DC.L	0                 ; NULL                         3B
	...
	DC.B	0,0,0,'8'         ; numeric pad 8 (8N)           3E
	DC.B	0,0,0,'9'         ; numeric pad 9 (9N)           3F
