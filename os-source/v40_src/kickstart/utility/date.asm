...
CalcDate:
	...
	MOVEQ     #12,D1
	CALL      UDivMod32	; d1=(month+9)%12
	ADD.L     D0,D2		; d2=year+(month+9)/12
	MOVE.L    #306,D0
	CALL      UMult32	; d0=((month+9)%12)*306
	ADDQ.L    #5,D0		; d0=((month+9)%12)*306+5
	MOVEQ     #10,D1
	CALL      UDivMod32	; d0=(((month+9)%12)*306+5)/10
	MOVE.L    D0,-(SP)
	SUBQ.L    #1,D2		; d2=year+(month+9)/12 -1
	MOVE.L    D2,D0		; d0=year+(month+9)/12 -1
	MOVEQ     #100,D1
	LSL.L     #2,D1
	CALL      UDivMod32	; d0=(year+(month+9)/12-1)/400
	MOVE.L    D0,-(SP)
	MOVE.L    D2,D0		; d0=year+(month+9)/12 -1
	MOVEQ     #100,D1
	CALL      UDivMod32	; d0=(year+(month+9)/12-1)/100
	MOVE.L    D0,-(SP)
	MOVE.L    D2,D1		; d1=year+(month+9)/12-1
	LSR.L     #2,D2		; d2=(year+(month+9)/12-1)/4
	MOVE.L    #365,D0
	CALL      UMult32	; d0=(year+(month+9)/12-1)*365
...
Amiga2Date:
	...
	MOVEQ.L   #7,d1
	CALL      UDivMod32	; d1=dayofweek
	MOVE.W    d1,wday(A0)
	MOVE.L    D2,D0
	ADDQ.L    #1,D0
	MOVE.L    #146097,D1
	CALL      UDivMod32	; d0=(absday+1)/146097
	...
	MOVEQ     #100,D1
	LSL.L     #2,D1
	CALL      UDivMod32	; d0=year/400
	SUB.L     D0,D2		; work-=year/400
	MOVE.L    D3,D0
	MOVEQ     #100,D1
	CALL      UDivMod32	; d0=year/100
	...
	MOVE.L    D3,D0
	MOVE.L    #365,D1
	CALL      UMult32	; d0=year*365
	SUB.L     D0,D2		; d2=work-=year*365

	MOVE.L    D2,D0
	MOVEQ     #102,D1
	NOT.B     D1
	CALL      UDivMod32	; d1=work%153
	MOVEQ     #10,D0
	CALL      UMult32	; d0=10*(work%153)
	MOVE.L    #305,D1
	CALL      UDivMod32	; d0=10*(work%153)/305
	MOVE.L    D0,D3
	MOVE.L    D2,D0
	MOVEQ     #102,D1
	NOT.B     D1
	CALL      UDivMod32	; d0=work/153
	MOVE.L    D0,D1
	LSL.L     #2,D1
	...
	MOVE.L    #306,D0
	MOVE.L    D3,D1
	CALL      UMult32	; d0=month*306
	ADDQ.L    #5,D0		; d0=month*306+5
	MOVEQ     #10,D1
	CALL      UDivMod32	; d0=(month*306+5)/10
	ADDQ.L    #1,D2
...
CheckDate:
	...
	CALL	Date2Amiga	; get AmigaTime
	move.l	(sp)+,a1	; ClockData
	move.l	sp,a0		; temp ClockData
	movem.l	d0/a1,-(sp)
	CALL	Amiga2Date 	; convert back
;	bra.s	CDCommon

;---------------------------------------------------------------------------

*** ABOVE ROUTINE FALLS THROUGH HERE
