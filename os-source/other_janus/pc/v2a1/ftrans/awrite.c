 ...
 *
 * Written for MICROSOFT-C 01-25-88 by Bill Koester (CATS) West Chester
...
char *argv[];
{
   ...
   if (argc<3)         
   { 
      puts("Usage: AWRITE PCfilename   Amigafilename  [/B] [/NC]");
      puts("       AWRITE PC-wild-card AmigaDirectory [/B] [/NC]");
         exit(10);
   }
