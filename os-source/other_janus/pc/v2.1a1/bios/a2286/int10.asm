...
SCROLL_SCR_UP   PROC    NEAR
        MOV     BL,AL                  ;SAVE # OF ROWS TO SCROLL
...
SCROLL_SCR_DWN  PROC    NEAR
        MOV     BL,AL                  ;SAVE ATTRIBUTE OF BLANK CHAR
...
V52:    IN      AL,DX                  ;WAIT FOR HORIZONTAL RETRACE HIGH
        AND     AL,1
        JZ      V52
        MOV     AX,ES:[BX]             ;READ ATTRIBUTE AND CHAR
        RET
;
...
;
V66:    CALL    WAIT_HRZ_RETRACE       ;WAIT HORIZONTAL RETRACE LOW
V66A:   IN      AL,DX                  ;WAIT HORIZONTAL RETRACE HIGH
        ...
        LOOP    V66                    ;KEEP DOING TILL COUNT=0
        RET
;
V67:    CALL    WAIT_HRZ_RETRACE       ;WAIT HORIZONTAL RETRACE LOW
V68:    IN      AL,DX                  ;WAIT HORIZONTAL RETRACE HIGH
        ...
        LOOP    V67                    ;KEEP DOING TILL COUNT=0
        RET
;
...
;
;	The size of this module must be 885h
;

empty_space	db	107 dup (0)

end_of_int10	label	byte

	if	(end_of_int10 - start_of_int10)
