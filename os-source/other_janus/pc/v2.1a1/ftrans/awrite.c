   ...
   if(error)
      switch(error)
      {
         ...
         case  JFT_ERR_NO_SERVER:
               puts("Error: DOSServ service not found.");
               break;
         case  JFT_ERR_NO_JANUS:
               puts("Error: Janus library not found.");
               break;
         ...
         case  JFT_ERR_INVALID_CONVERSION_MODE:
               ...
               break;
         case  JFT_ERR_PC_DIRECTORY:
               puts("Input must be a file.");
               break;
         case  JFT_ERR_PC_READ:
               puts("PC read error.");
               break;
         case  JFT_ERR_PC_WRITE:
               puts("PC write error.");
               break;
        default:
               puts("Unknown error.");
