...
JOHNB	EQU	0	;0=normal, 1=don't wait for amiga
NOTTEST	EQU	1	;0=normal, 1=don't test timers
...
;disable all weird stuff except the floppy
	mov	dx,0ech
	mov	al,1eh
	out	dx,al
