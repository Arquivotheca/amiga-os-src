...
IF BRIDGEBOARD
IF A2286
 db '³ Commodore A2286 BIOS Rev. 4.2               380682 - 04     ³',0dh,0ah
 DB '³                                             380683 - 04     ³',0dh,0ah
ELSE
 db '³ Commodore A2386 BIOS Rev. 4.2               xxxxxx - 00     ³',0dh,0ah
 DB '³                                                             ³',0dh,0ah
ENDIF
ELSE
...
IF A2286
 ...
 DB '³       Rev. 4.2            380683-04 ³',0dh,0ah
ELSE
 db '³ Commodore A2386 BIOS      xxxxxx-00 ³',0dh,0ah
 DB '³       Rev. 4.2                      ³',0dh,0ah
ENDIF
ELSE
