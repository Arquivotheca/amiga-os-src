...
;		19-feb-91 rsd	- fix MaxInt range checking to be >= maxint,
;				  not > maxint (B10301)
;				- fix FreeMem failure code to unlock only the
;				  lock it locked.
;				- put CLD before MOVS & STOS instruction
;		20-feb-91 rsd	- move STI inside WaitAmiga loop
;
;******************************************************************************
