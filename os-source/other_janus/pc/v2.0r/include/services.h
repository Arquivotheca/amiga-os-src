...
#define JFUNC_MAX		16 	/* Last function (for range check only) */
...
#define GETS_AUTOWAITmask	  0x0300
#define GETS_AUTOWAIT_0		  0x0000
#define GETS_AUTOWAIT_15 	  0x0100
#define GETS_AUTOWAIT_30 	  0x0200
#define GETS_AUTOWAIT_120	  0x0300
