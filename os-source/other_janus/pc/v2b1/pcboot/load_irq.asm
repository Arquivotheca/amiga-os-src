...
loadmsg       	db  0ah,0dh," Janus handler V2.60 found at segment ",0
copymsg		db  0ah,0ah,0dh," Copyright (c) 1988, Commodore Amiga Inc."
		db  0ah,0dh,"         All rights reserved.   ",0
		db  "Torsten Burgdorff"
;												 
;--------------------------------------------
;
run:					     	; here we go
...
;	mov  	es:JanusAmiga.jpm_pad0,'T'     	; set "here I am" to DJMOUNT
;	mov  	es:JanusAmiga.jbm_pad0,'B'     	; set another "here I am"
