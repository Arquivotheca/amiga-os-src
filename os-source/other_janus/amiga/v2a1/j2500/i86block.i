...
; extra functions added for the PCDisk/jlink combination
ADR_FNCTN_OPEN_OLD  EQU	    5   ; given ASCIIZ pathname
ADR_FNCTN_OPEN_NEW  EQU     6   ; given ASCIIZ pathname
...
; extra errors added for the PCDisk/jlink combination
ADR_ERR_SEEK	    EQU	    8
ADR_ERR_READ	    EQU     9
ADR_ERR_WRITE	    EQU	    10
ADR_ERR_LOCKED      EQU     11  ; file already opened
