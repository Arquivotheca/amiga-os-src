...
/* === Menu Definitions ================================================== */
#define MENU_HEADERS_COUNT    3L

/*???ADJUST KEY TIMING*/
#define PROJECT_ITEMS_COUNT   6L
#define EDIT_ITEMS_COUNT      1L
#define DISPLAY_ITEMS_COUNT   12L

#define PROJECT_MENU          0L
#define DISPLAY_MENU          1L
#define EDIT_MENU             2L

/*???ADJUST KEY TIMING*/
#define SAVE_ITEM             0L
#define RESTORE_ITEM          1L
#define HELP_ITEM             2L
#define ADJUST_ITEM           3L
#define ABOUT_ITEM            4L
#define CLOSE_ITEM            5L

/*#define COPY_ITEM             0*/
#define PASTE_ITEM            0L

#define FULLSIZE_ITEM         0L
#define SMALLSIZE_ITEM        1L
#define SHOWBORDER_ITEM       2L
/*#define HIDEBORDER_ITEM       3*/
#define FREEZE_ITEM           3L
#define LOCALE_ITEM           4L
#define COLOR_ITEM            5L
#define CURSOR_ITEM           6L
#define NEWWINDOW_ITEM        7L
#define REFRESH_ITEM          8L
#define DEPTH_ITEM            9L
#define PRIORITY_ITEM         10L
#define INTERLACE_ITEM        11L

#define HELP_SUBITEMS_COUNT   7L


#define SAFE_HEIGHT           9L
...
#define ADD_DISPLAY        1L
#define REMOVE_DISPLAY     2L
#define GET_DISPLAYLIST    3L
#define NEW_PRIORITY       4L
#define GET_QUEUEROUTINE   5L
#define DEADEN_BLINK       6L
#define REVIVE_BLINK       7L
#define COUNT_WBWINDOWS    11L
#define CHANGE_WBWINDOWS   12L
...
#define DEFAULT_CURSOR_SECONDS   0L
#define DEFAULT_CURSOR_MICROS    (1000000L / 4L)

#define CURSORPRIORITY_OFFSET    0L
...
#define BORDER_TOGGLE   1L
#define BORDER_ON       2L
#define BORDER_OFF      3L
...
/* === Abort() Definitions =============================================== */
#define ALERT_ABORT              0L
#define ALERT_BAD_KEYS_FILE      1L
#define ALERT_NO_SIGNALS         2L
#define ALERT_INCOMPLETESYSTEM   3L
#define ALERT_NO_MEMORY          4L
#define ALERT_NO_LIBRARY         5L
#define ALERT_NO_NEWREGION       6L
#define ALERT_NO_INPUTPORT       7L
#define ALERT_NO_PCFONT          8L
#define ALERT_NO_TIMERPORT       9L
#define ALERT_BAD_UNLOCK_TASK    10L
#define ALERT_NO_JANUS_SIG       11L
#define ALERT_BAD_SETTINGS_FILE  12L
/*#define ALERT_COPY_HELP          13*/
#define ALERT_DUPLICATE_DISPLAY  14L
#define ALERT_BAD_SCANCODE_FILE  15L
#define ALERT_FROZEN_BORDER      16L
#define ALERT_FROZEN_TEXT        17L
#define ALERT_RJ                 18L
#define RJ_WAS_HERE              19L
#define ALERT_OLD_KEYSFILE       20L

#define ALERT_NO_DISPLAY_STRUC_MEMORY  21L
#define ALERT_NO_GRAPHICS_LIB          22L
#define ALERT_NO_LAYERS_LIB            23L
#define ALERT_NO_DISKFONT_LIB          24L
#define ALERT_NO_JANUS_LIB             25L
#define ALERT_ALREADY_OPEN             26L
#define ALERT_NO_DISP_BUFF_MEMORY      27L
#define ALERT_NO_FONT_MEMORY           28L
#define ALERT_NO_UFONT_MEMORY          29L
#define ALERT_NO_TEXT_CLIP             30L
#define ALERT_NO_SUPER_WINDOW_MEMORY   31L
#define ALERT_NO_COLOR_WINDOW_MEMORY   32L
#define ALERT_NO_TASK_STACK_MEMORY     33L
#define ALERT_NO_PC_DISPLAY_MEMORY     34L
#define ALERT_NO_EXTRA_SCREEN_MEMORY   35L
#define ALERT_NO_WINDOW_MEMORY         36L
#define ALERT_NO_EXTENSION_WINDOW_MEMORY  37L
...
#define CRT_R14   28L
#define CRT_R15   30L
#define CRT_IOBLOCKSIZE 32L  /* This *must* be an even number */
 ...
 */
#define KEYBUFFER_SIZE       512L
#define KEYBUFFER_MASK       (KEYBUFFER_SIZE - 1L)
...
#define COLOR_MIN_INTENSITY   3L
#define COLOR_LOW_INTENSITY   10L
#define COLOR_HIGH_INTENSITY  15L
#define MIN_RED        (COLOR_MIN_INTENSITY << 8L)
#define MIN_GREEN      (COLOR_MIN_INTENSITY << 4L)
#define MIN_BLUE       (COLOR_MIN_INTENSITY << 0L)
#define LOW_RED        (COLOR_LOW_INTENSITY << 8L)
#define LOW_GREEN      (COLOR_LOW_INTENSITY << 4L)
#define LOW_BLUE       (COLOR_LOW_INTENSITY << 0L)
#define HIGH_RED       (COLOR_HIGH_INTENSITY << 8L)
#define HIGH_GREEN     (COLOR_HIGH_INTENSITY << 4L)
#define HIGH_BLUE      (COLOR_HIGH_INTENSITY << 0L)

#define HORIZ_GADGET    1L
#define VERT_GADGET     2L
...
#define FULLSIZE           0x0008
#define OPENED_ONCE        0x0010
 ...
 */
#define BUFFER_WIDTH    80L /* For output text, a multiple of 20 */
#define CHAR_HEIGHT     8L  /* To change this one won't be too bad */
#define CHAR_WIDTH      8L  /* To change this would be horrendous */

#define CHAR_BASEROW    6L
#define CHAR_BASECOL    0L
...
struct Display
   {
    ...
    /*ULONG TripleSeconds, TripleMicros;*//*Usedwhen checking triple-click */
...
#define COLOR_CRT_NOTHING   1L
#define COLOR_CRT_REVAMP    2L
#define COLOR_CRT_REDRAW    3L



/* === The definitions for ColorWindow =================================*/
#define COLOR_BOX_LEFT     7L
#define COLOR_BOX_TOP      6L
#define COLOR_BOX_RIGHT    (COLOR_BOX_LEFT + 15L)
#define COLOR_BOX_BOTTOM   (COLOR_BOX_TOP + 29L)
#define COLOR_COLOR_TOP    45L

#define COLOR_KNOB_BODY    0x1111

#define COLORWINDOW_WIDTH  208L
#define COLORWINDOW_HEIGHT 91L

#define CHARACTER_WIDTH    8L
#define CHARACTER_HEIGHT   8L
 ...
 */
#define COLOR_COPY            0L
#define COLOR_RANGE           1L
#define COLOR_OK              2L
#define COLOR_CANCEL          3L
#define COLOR_GREEN           4L
#define COLOR_RED             5L
#define COLOR_BLUE            6L
#define COLOR_HSL_RGB         7L
#define COLOR_GADGETS_COUNT   8L
...
#define ZAPHOD_HEIGHT   200L

#define SHIFTY          (IEQUALIFIER_LSHIFT | IEQUALIFIER_RSHIFT \
                         | IEQUALIFIER_CAPSLOCK)


#define TITLEBAR_HEIGHT       10L

#define NTSC_TOP_ONHEIGHT     0L
#define NTSC_TOP_OFFHEIGHT    0L

#define NTSC_EXTRAHEIGHT      0L

#define PAL_TOP_ONHEIGHT      11L
#define PAL_TOP_OFFHEIGHT     11L

#define PAL_EXTRAHEIGHT       (PAL_TOP_ONHEIGHT + 10L)

#define PAL_MEDIUM_OFFSET     8L
#define PAL_HIGH_OFFSET       7L
