...
static struct IntuiText HelpText[HELP_TEXT_COUNT] =
   {
      {
...
static UBYTE *HelpStrings[HELP_SUBITEMS_COUNT][HELP_TEXT_COUNT] =
   {
...
/*      },*/
      ...
      (UBYTE *)"There are some PC keys that aren't",
      (UBYTE *)"on all Amiga keyboards. You can",
      (UBYTE *)"transmit these keys by typing the",
	  (UBYTE *)"following control sequences:",
      (UBYTE *)"",
      (UBYTE *)"   Num lock - Right AMIGA & N",
      (UBYTE *)"              Left  AMIGA & NumL",
      (UBYTE *)"Scroll Lock - Right AMIGA & S",
      (UBYTE *)"              Left  AMIGA & ScrL",
      (UBYTE *)"   Prt Sc * - Right AMIGA & P",
      (UBYTE *)"+ on Keypad - Right AMIGA & +",
      (UBYTE *)"      Break - Control & Scroll Lock",
      (UBYTE *)"",
      },
...
static SHORT MostRecentHelp = HELP_SUBITEMS_COUNT - 1;
