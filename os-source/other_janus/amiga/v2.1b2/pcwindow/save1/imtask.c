...
#define  DBG_INPUT_MONITOR_ENTER                         1
#define  DBG_INPUT_MONITOR_OFFSETS                       1
#define  DBG_QUEUE_PC_RAW_KEY_ENTER                      1
#define  DBG_QUEUE_ONE_KEY_ENTER                         1
#define  DBG_SEND_ONE_KEY_ENTER                          1
#define  DBG_SEND_ONE_KEY_ADDRESSES                      0
#define  DBG_CLOSE_INPUT_MONITOR_TASK_ENTER              1
#define  DBG_IRVING_FORCES_FF_DOWN_ZAPHODS_THROAT_ENTER  1
...
/* === End of Critical Section ========================================== */
   ...
   /*???else kprintf("Imtask.c: On entry, neither RESET nor SET was set\n");*/
              ...
              || (code == (AmigaRightAltCode | 0x80)))
         {
                 ...
                 || (code == AmigaBarBackSlash)) )
            {
                     ...
                     || (code == AmigaCursorDown) ) )
               {
                  ...
                  {
                     /*?kprintf("Imtask.c: SET was clear?\n");*/
                     QueueOneKey(PCNumLockCode);
                        ...
                        || (code == (AmigaCursorDown | 0x80) ) )) 
                  {
                     ...
                     if (KeyFlags & (KEY_AMIGA | KEY_AMIGAPENDING))
                     {
                        ...
                        if (code == AmigaNCode)
                        {
                           ...
                           /*?kprintf("Imtask.c: if (code == AmigaNCode) ToggleFlag(KeyFlags, KEY_NUMLOCK_SET); \n");*/
...
INELEGANT_SO_BUGGER_OFF:
                        ...
                        /*?kprintf("Imtask.c: code=$%lx ", (ULONG)(code));*/
                        /*?kprintf("Imtask.c: outcode=$%lx\n", (ULONG)(outcode));*/
                        ...
                        {
                           ToggleFlag(KeyFlags, KEY_NUMLOCK_SET); 
                           /*?kprintf("Imtask.c: if (outcode == PCNumLockCode) ToggleFlag(KeyFlags, SET);\n");*/
                        }
...
{
#if (DEBUG1 & DBG_IRVING_FORCES_FF_DOWN_ZAPHODS_THROAT_ENTER)
   kprintf("imtask.c:     IrvingForcesFFDownZaphodsThroat(VOID)\n");
#endif
