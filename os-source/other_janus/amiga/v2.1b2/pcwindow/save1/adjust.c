...
#define  DBG_ADJUST_START_ENTER        1
#define  DBG_ADJUST_START_RETURN       1
#define  DBG_ADJUST_KEY_TIMING_ENTER   1
#define  DBG_ADJUST_KEY_TIMING_RETURN  1
...
#if (DEBUG1 & DBG_ADJUST_START_ENTER)
   kprintf("Adjust.c:     AdjustStart(VOID)\n");
#endif

   success=ActivateGadget(&AdjustMicros, AdjustWindow, &AdjustSupport.Requester);

#if (DEBUG2 & DBG_ADJUST_START_RETURN)
   kprintf("Adjust.c:     AdjustStart: Returns(0x%lx)\n",success);
#endif
...
void AdjustKeyTiming(display)
struct Display *display;
{
#if (DEBUG1 & DBG_ADJUST_KEY_TIMING_ENTER)
   kprintf("Adjust.c:     AdjustKeyTiming(display=0x%lx)\n",display);
#endif
...
#if (DEBUG2 & DBG_ADJUST_KEY_TIMING_RETURN)
   kprintf("Adjust.c:     AdjustKeyTiming: Returns(VOID)\n");
#endif
}
