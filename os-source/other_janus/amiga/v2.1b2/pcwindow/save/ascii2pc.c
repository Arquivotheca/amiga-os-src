...
void SendASCIIAsPCKeyCodes();
void SendKeypadDigit();

void SendASCIIAsPCKeyCodes(c)
USHORT c;
{
   UBYTE flag, keycode;
   REGIST   SHORT   i;
...
#ifdef DEBUG
   kprintf("ASCII2PC.c: SendASCIIAsPCKeyCodes(0x%lx)\n",c);
#endif
...
void SendKeypadDigit(digit)
REGIST   UBYTE   digit;
{

#ifdef DEBUG
   kprintf("ASCII2PC.c: SendKeypadDigit(0x%lx)\n",digit);
#endif
