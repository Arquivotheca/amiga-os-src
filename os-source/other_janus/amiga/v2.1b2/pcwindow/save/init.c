...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod(Enter)\n");
#endif
...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod: SaveA4 was here\n");
#endif

   MainTask = FindTask(0);

#ifdef DEBUG
   kprintf("Init.c: InitZaphod: After FindTask\n");
#endif
...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod: Before OpenAuxTools\n");
#endif

   OpenAuxTools(display);

#ifdef DEBUG
   kprintf("Init.c: InitZaphod: After OpenAuxTools\n");
#endif

   if (DuplicateDisplay(display)) 
      {
      MyAlert(ALERT_DUPLICATE_DISPLAY, NULL);
      goto DONE;
      }

#ifdef DEBUG
   kprintf("InitZaphod: After DuplicateDisplay\n");
#endif
...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod: After Allocs\n");
#endif
...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod: After planes set\n");
#endif
...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod: After read settings\n");
#endif
...
#ifdef DEBUG
   kprintf("Init.c: InitZaphod: After font stuff\n");
#endif
