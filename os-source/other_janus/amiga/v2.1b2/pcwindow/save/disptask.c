...
#ifdef DEBUG
   kprintf("DisplayTask: Before TaslkWithZaphod\n");
#endif
...
/* === End of critical section ========================================== */
   ...
   janusCRTNum = JSERV_CRT1INT;
    ...
    display->CRTWriteSig = (struct SetupSig *)SetupJanusSig(janusCRTNum,
       CreateSignalNumber(CRTRegisterWriteSignal), 0, 0);
    display->DisplayWriteSig = (struct SetupSig *)SetupJanusSig(janusDisplayNum,
