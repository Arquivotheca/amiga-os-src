...
USHORT c;
{
	...
	if (KeyQueuer)
		...
		if (FlagIsSet(flag, PC_CONTROL)) (*KeyQueuer)(PCCtrlCode);
		if (FlagIsSet(flag, PC_SHIFT)) (*KeyQueuer)(PCLeftShiftCode);
		(*KeyQueuer)(keycode);
		(*KeyQueuer)(keycode | 0x80);
		if (FlagIsSet(flag, PC_SHIFT)) (*KeyQueuer)(PCLeftShiftCode | 0x80);
		if (FlagIsSet(flag, PC_CONTROL)) (*KeyQueuer)(PCCtrlCode | 0x80);
		}
