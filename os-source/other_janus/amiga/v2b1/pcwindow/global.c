...
#ifndef RELEASE
UBYTE Version[] = "Zaphod Version 1.99, 1 July 1988";
#endif
#ifdef RELEASE
UBYTE Version[] = "Zaphod Version 2.0, 4 July 1988";
#endif
...
UBYTE	ScanCodeFile[] = ":Sidecar/ScanCode.Table";
UBYTE	*AllSetPlane;
UBYTE	*AllClearPlane;
...
BYTE	PCTildeCode = 0;
BYTE	PCBarCode = 0;
BYTE	PCBackDashCode = 0;
BYTE	PCBackSlashCode = 0;
...
BYTE	AmigaSCode = 0;
BYTE	AmigaPrtScrCode = 0;
BYTE	AmigaTildeBackDash = 0;
BYTE	AmigaBarBackSlash = 0;

BYTE	PCKeypad8 = 0xFF;
BYTE	PCKeypad4 = 0xFF;
BYTE	PCKeypad6 = 0xFF;
BYTE	PCKeypad2 = 0xFF;
BYTE	AmigaCursorUp = 0xFF;
BYTE	AmigaCursorLeft = 0xFF;
BYTE	AmigaCursorRight = 0xFF;
BYTE	AmigaCursorDown = 0xFF;
