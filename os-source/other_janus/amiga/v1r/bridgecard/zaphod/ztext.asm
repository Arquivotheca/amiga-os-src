...
*    (I believe that it's valid for me to make such a statement)
* 
...
* ------------	--------------	----------------------------------------------
* 8 Mar 86	RJ Mical>:-{)*	I'm a little over 2 meters tall, quite handsom
*
* ****************************************************************************
...
* *************************************************************************
*
* This routine sets for a color call to ZText()
*
* ON ENTRY:
*
