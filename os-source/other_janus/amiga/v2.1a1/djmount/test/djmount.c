...
#define  DEBUG_PCRUNNING   1
#define  DEBUG_WAITPC      1
#define  DEBUG_REQPTR      1
#define  DEBUG_INITERR     1
#define  DEBUG_NUMOFPARTS  1
#define  DEBUG_PARTTABLE   1
#define  DEBUG_PARTINFO    1
